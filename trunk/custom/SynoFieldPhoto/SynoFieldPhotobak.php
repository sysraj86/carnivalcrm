            ...
            foreach ($focus->field_name_map as $key => $fieldDef) {
                if (
                    ...
                    if(!empty($focus->$picture_field_name)){
                        ...
                        $old_picture_path = 'custom/SynoFieldPhoto/phpThumb/images/'.$focus->module_dir.'_'.$focus->field_name_map[$key]['name'].'_.jpg';
                        $new_picture_path = 'custom/SynoFieldPhoto/phpThumb/images/new_'.$focus->module_dir.'_'.$focus->field_name_map[$key]['name'].'_.jpg';
                        ...
                        $old_picture_path = 'custom/SynoFieldPhoto/phpThumb/images/'.$focus->module_dir.'_'.$focus->field_name_map[$key]['name'].'_.jpg';
                        //$old_picture_path = 'custom/SynoFieldPhoto/phpThumb/images/'.$focus->module_dir.'_'.$focus->field_name_map[$key]['name'].'_'.$focus->id.'.jpg';
                        if(is_file( $old_picture_path )){
