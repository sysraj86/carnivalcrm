...
$layout_defs["Services"]["subpanel_setup"]["activities"] = array (
  'order' => 10,
  'sort_order' => 'desc',
  'sort_by' => 'date_start',
  ...
  array (
    ...
    array (
      ...
      'get_subpanel_data' => 'services_activities_meetings',
    ),
    'tasks' => 
    array (
      'module' => 'Tasks',
      'subpanel_name' => 'ForActivities',
      'get_subpanel_data' => 'services_activities_tasks',
    ),
    'calls' => 
    array (
      'module' => 'Calls',
      'subpanel_name' => 'ForActivities',
      'get_subpanel_data' => 'services_activities_calls',
    ),
  ),
  'get_subpanel_data' => 'activities',
);
$layout_defs["Services"]["subpanel_setup"]["history"] = array (
  'order' => 20,
  'sort_order' => 'desc',
  ...
  array (
    ...
    array (
      'module' => 'Notes',
      'subpanel_name' => 'ForHistory',
      'get_subpanel_data' => 'services_activities_notes',
    ),
    'emails' => 
    array (
      'module' => 'Emails',
      'subpanel_name' => 'ForHistory',
      'get_subpanel_data' => 'services_activities_emails',
    ),
  ),
...
$layout_defs["Services"]["subpanel_setup"]["services_contacts"] = array (
  'order' => 100,
  'module' => 'Contacts',
  'subpanel_name' => 'default',
  'sort_order' => 'asc',
  'sort_by' => 'id',
  'title_key' => 'LBL_SERVICES_CONTACTS_FROM_CONTACTS_TITLE',
  'get_subpanel_data' => 'services_contacts',
  'top_buttons' => 
  array (
    0 => 
    array (
