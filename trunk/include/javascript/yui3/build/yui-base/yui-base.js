...
(function () {
    ...
    }, _APPLY_TO_WHITE_LIST = {'io.xdrReady':1, 'io.start':1, 'io.success':1, 'io.failure':1}, SLICE = Array.prototype.slice;
    ...
    YUI.prototype = {_config:function (o) {
        ...
        Y.constructor = YUI;
        Y.config = {win:window || {}, doc:document, debug:true, useBrowserConsole:true, throwFail:true, base:function () {
            var b, nodes, i, match;
        ...
        var Y = this, a = SLICE.call(arguments, 0), mods = YUI.Env.mods, used = Y.Env._used, loader, firstArg = a[0], dynamic = false, callback = a[a.length - 1], k, i, l, missing = [], r = [], f = function (name) {
            if (used[name]) {
                return;
            }
