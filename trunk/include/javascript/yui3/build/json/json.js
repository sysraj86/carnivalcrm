...
YUI.add('json-stringify', function (Y) {
    ...
    function _stringify(o, w, space) {
        ...
        var replacer = isFunction(w) ? w : null, format = _toStr.call(space).match(/String|Number/) || [], _date = Y.JSON.dateToString, stack = [], tmp, i, len;
    ...
    Y.mix(Y.namespace('JSON'), {useNativeStringify:!!Native, dateToString:function (d) {
        function _zeroPad(v) {
            return v < 10 ? '0' + v : v;
        }
        ...
        return Native && Y.JSON.useNativeStringify ? Native.stringify(o, w, ind) : _stringify(o, w, ind);
    }});
}, '3.0.0');
YUI.add('json', function (Y) {
}, '3.0.0', {use:['json-parse', 'json-stringify']});