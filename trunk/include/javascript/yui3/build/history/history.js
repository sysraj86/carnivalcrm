...
YUI.add('history', function (Y) {
    ...
    if (!YUI.Env.history) {
        YUI.Env.history = G = {ready:false, _modules:[], _stateField:null, _historyIFrame:null};
    }
    if (Y.UA.gecko) {
        _getHash = function () {
    ...
    function _initialize() {
        ...
        if (!Y.Lang.isUndefined(win.onhashchange) && (Y.Lang.isUndefined(doc.documentMode) || doc.documentMode > 7)) {
    ...
    H = {register:function (moduleId, initialState) {
        var module;
