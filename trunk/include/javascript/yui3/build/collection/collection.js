...
YUI.add('collection', function (Y) {
    ...
    A.lastIndexOf = (Native.lastIndexOf) ? function (a, val) {
    ...
    A.filter = (Native.filter) ? function (a, f, o) {
    ...
    A.every = (Native.every) ? function (a, f, o) {
    ...
    A.map = (Native.map) ? function (a, f, o) {
    ...
    A.reduce = (Native.reduce) ? function (a, init, f, o) {
