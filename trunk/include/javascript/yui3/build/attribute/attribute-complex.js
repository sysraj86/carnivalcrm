...
YUI.add('attribute-complex', function (Y) {
    ...
    Y.Attribute.Complex.prototype = {_normAttrVals:function (valueHash) {
        ...
        var val = (cfg.valueFn) ? cfg.valueFn.call(this) : cfg.value, simple, complex, i, l, path, subval, subvals;
