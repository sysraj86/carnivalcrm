...
YUI.add('cookie', function (Y) {
    var L = Y.Lang, O = Y.Object, NULL = null, isString = L.isString, isObject = L.isObject, isUndefined = L.isUndefined, isFunction = L.isFunction, encode = encodeURIComponent, decode = decodeURIComponent, doc = Y.config.doc;
    ...
    Y.Cookie = {_createCookieString:function (name, value, encodeValue, options) {
        ...
        if (isString(text) && text.length > 0) {
            var decodeValue = (shouldDecode === false ? function (s) {
                return s;
            } : decode), cookieParts = text.split(/;\s/g), cookieName = NULL, cookieValue = NULL, cookieNameValue = NULL;
        ...
        validateCookieName(name);
        options = Y.merge(options || {}, {expires:new Date(0)});
