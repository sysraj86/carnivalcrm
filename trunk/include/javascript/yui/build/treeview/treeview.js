...
(function () {
    ...
    TV.prototype = {
        ...
        _getEventTargetTdEl:function (ev) {
            ...
            if (Lang.isNull(target)) {
                return null;
            }
            // If it is a spacer cell, do nothing
            if (/\bygtv(blank)?depthcell/.test(target.className)) {
                return null;
            }
    ...
    YAHOO.widget.Node.prototype = {
        ...
        getNodeDefinition:function () {
            ...
            if (!this.renderHidden) {
                defs.renderHidden = this.renderHidden;
            }
            if (!this.hasIcon) {
                defs.hasIcon = this.hasIcon;
            }
            if (this.nowrap) {
                defs.nowrap = this.nowrap;
            }
            if (this.className) {
                defs.className = this.className;
            }
            if (this.editable) {
                defs.editable = this.editable;
            }
            if (this.enableHighlight) {
                defs.enableHighlight = this.enableHighlight;
            }
            if (this.highlightState) {
                defs.highlightState = this.highlightState;
            }
            if (this.propagateHighlightUp) {
                defs.propagateHighlightUp = this.propagateHighlightUp;
            }
            if (this.propagateHighlightDown) {
                defs.propagateHighlightDown = this.propagateHighlightDown;
            }
...
(function () {
    ...
    YAHOO.extend(YAHOO.widget.DateNode, YAHOO.widget.TextNode, {
        ...
        getNodeDefinition:function () {
            ...
            if (this.calendarConfig) {
                def.calendarConfig = this.calendarConfig;
            }
            return def;
        }
