...
YAHOO.util.History = (function () {
    ...
    return{onLoadEvent:new YAHOO.util.CustomEvent("onLoad"), onReady:function (L, M, N) {
        if (F) {
            setTimeout(function () {
                var O = window;
                if (N) {
            ...
            YAHOO.util.History.onLoadEvent.subscribe(L, M, N);
        }
    }, register:function (N, L, P, Q, R) {
        var O, M;
        if (typeof N !== "string" || YAHOO.lang.trim(N) === "" || typeof L !== "string" || typeof P !== "function") {
        ...
        D[N] = {name:N, initialState:L, currentState:L, onStateChange:M};
        ...
        if (!L || L.tagName.toUpperCase() !== "TEXTAREA" && (L.tagName.toUpperCase() !== "INPUT" || L.type !== "hidden" && L.type !== "text")) {
            throw new Error("Missing or invalid argument");
        }
        K = L;
