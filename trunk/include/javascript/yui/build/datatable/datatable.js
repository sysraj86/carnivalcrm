...
// COLUMN FUNCTIONS
            ...
            if (oColumn) {
                ...
                if (nColTreeIndex !== null) {
                    ...
                    if (aKeyIndexes !== null) {
                        ...
                        aKeyIndexes.sort(function (a, b) {
                            return YAHOO.util.Sort.compare(a, b);
                        });
        ...
        insertColumn:function (oColumn, index) {
            ...
            if (descKeyIndexes.length > 0) {
                // Sort the indexes
                var newIndex = descKeyIndexes.sort(function (a, b) {
                    return YAHOO.util.Sort.compare(a, b);
                })[0];
        ...
        reorderColumn:function (oColumn, index) {
            ...
            if (oColumn && YAHOO.lang.isNumber(index)) {
                ...
                if ((nOrigTreeIndex !== null) && (nOrigTreeIndex !== index)) {
                    ...
                    if (aOrigKeyIndexes !== null) {
                        // Sort the indexes
                        aOrigKeyIndexes.sort(function (a, b) {
                            return YAHOO.util.Sort.compare(a, b);
                        });
                        ...
                        var newIndex = aNewKeyIndexes.sort(function (a, b) {
                            return YAHOO.util.Sort.compare(a, b);
                        })[0];
