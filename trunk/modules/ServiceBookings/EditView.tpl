    ...
    <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" class="tabForm">
        ...
        <tr>
            ...
            <td class="dataField">
                ...
                <input type="text" data="Button=cleardata,selectdata|Module=Users|Fields=id,user_name,phone_work,email1|Inputs=attn_id,attn_name,attn_phone,attn_email" class="select" name="attn_phone" id="attn_phone" value="{$ATTN_PHONE}"/>
            </td>
        </tr>
        <tr>
