...
// A RECORD ID IS NOT GIVEN WHEN VIEWING IN LAYOUT EDITOR
   ...
   if(isset($_REQUEST['isDuplicate']) && $_REQUEST['isDuplicate'] == 'true') {
    ...
    $GLOBALS['log']->info("ServiceBookings detail view");

    $xtpl=new XTemplate ('modules/ServiceBookings/DetailView.html');
    ...
    $xtpl->assign('RES', $focus->services_seebookings_name);
    $xtpl->assign('RES_ID', $focus->services_sde2fervices_ida);
    ...
    $xtpl->assign('MADETOUR', $focus->groupprograebookings_name);
    $xtpl->assign('MADETOUR_ID', $focus->groupprogr0d2frograms_ida);
