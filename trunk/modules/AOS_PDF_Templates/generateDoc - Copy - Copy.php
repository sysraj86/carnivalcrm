...
@page WordSection1
    ...
    mso-header:url("'.$sugar_config['site_url'].'/modules/modules/AOS_PDF_Templates/hd_files/header.htm") h1;
    mso-even-footer:url("'.$sugar_config['site_url'].'/modules/AOS_PDF_Templates/hd_files/header.htm") ef1;
    mso-footer:url("'.$sugar_config['site_url'].'/modules/modules/AOS_PDF_Templates/hd_files/header.htm") f1;
...
';
    ...
    //$doc->addText($template->pdfheader);
    //$doc->endSession();
