 ...
 * PLACE ANY CUSTOMIZATIONS IN a_FITs
 */

require_once('include/SugarObjects/templates/person/Person.php');

class FITs_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'FITs';
	var $object_name = 'FITs';
	var $table_name = 'fits';
	var $importable = true;
    ...
    var $potential;
    var $career;
    var $accumulation_score;
    
    // for relate field
    var $contract_id;
      
    
    var $additional_column_fields = array('account_name','account_id','contract_id')    ;
    var $relationship_fields  = array('account_id' => 'accounts','contract_id'=>'contracts');            
