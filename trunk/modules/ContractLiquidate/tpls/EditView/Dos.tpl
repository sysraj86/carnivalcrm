...
<form action="index.php"  name="EditView" id="EditView" method="post">
    ...
    <input type="hidden"   name="type"  value="Dos">
    <div class="container"> 
    ...
    <table cellpadding="0" cellpadding="0" border="0" width="100%" class="tabForm">
        <tr>
            ...
            <input type="hidden" data="Button=cleardata,selectdata|Module=Contracts|Fields=id,number,parent_type|Inputs=contract_id,contract,parent_type" class="select" name="contract_id" id="contract_id" value="{$CONTRACT_ID}">
...
<tr align="center">
    <td class="td_content" width="324" rowspan="2"><b>{$MOD.LBL_NOIDUNG}</b></td>
    <td class="td_content" width="300" colspan="3"><b>{$MOD.LBL_KEHOACH}</b></td>
    <td class="td_content" width="300" colspan="3"><b>{$MOD.LBL_THUCTE}</b></td>
    <td class="td_content" width="100">&nbsp;</td>
</tr>
<tr align="center">
    <td class="td_content" width="100"><b>{$MOD.LBL_DONGIA}</b></td>
    <td class="td_content" width="100"><b>{$MOD.LBL_SL}</b></td>
    <td class="td_content" width="100"><b>{$MOD.LBL_THANHTIEN}</b></td>
    <td class="td_content" width="100"><b>{$MOD.LBL_DONGIA}</b></td>
    <td class="td_content" width="100"><b>{$MOD.LBL_SL}</b></td>
    <td class="td_content" width="100"><b>{$MOD.LBL_THANHTIEN}</b></td>
...
<tr>
<td class="td_content"><b>IV/{$MOD.LBL_BENBTHANHTOANBENA}</b></td>
<td class="td_content">&nbsp;</td>
<td class="td_content">&nbsp;</td>
<td class="td_content">&nbsp;</td>
<td class="td_content">&nbsp;</td>
...
<tr>
<td class="td_content"><b>V/{$MOD.LBL_BENBNOBENA}</b></td>
<td class="td_content">&nbsp;</td>
<td class="td_content">&nbsp;</td>
<td class="td_content">&nbsp;</td>
<td class="td_content">&nbsp;</td>
...
<tr>
    <td colspan="8" class="td_content" align="center">{$MOD.LBL_BANGCHU} : &nbsp;<input name="bangchu" type="text" size="90" id="bangchu" value="{$BANGCHU}" /> USD </td>
</tr>
</table>
</td>
</tr>
    ...
    <table cellpadding="0" cellspacing="0" class="tabForm" width="100%" border="0">
        <tr>
            ...
            <td class="dataField" width="30%">
                ...
                <input data="Button=cleardata,selectdata|Module=Users|Fields=id,user_name|Inputs=assigned_user_id,assigned_user_name" class="select" id='assigned_user_id' name='assigned_user_id' type="hidden" value="{$ASSIGNED_USER_ID}" />
