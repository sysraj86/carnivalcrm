...
class AccountsViewDetail extends ViewDetail {
 	 ...
 	 */
 	function display(){
		$this->Get_city_provice($this->bean);		
    ...
    function Get_city_provice($bean){
          global $db;
          ...
          switch($row['country']){                
              case "VIETNAM" :   $app_list_strings['city_province_dom_c'] = $app_list_strings['province_VIETNAM_list'];break;
              case "THAILAND" :   $app_list_strings['city_province_dom_c'] = $app_list_strings['province_THAILAND_list']; break;
              case "CAMBODIA" :   $app_list_strings['city_province_dom_c'] = $app_list_strings['province_CAMPUCHIA_list']; break;
              default :   $app_list_strings['city_province_dom_c'] = $app_list_strings['province_NULL_list'];
          }
      }	
}
