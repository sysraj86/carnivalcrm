 ...
 array (
      ...
      'country_name' => 
          ...
          'province_city'    => array(
            'required' => false,
            'name' => 'province_city',
            'vname' => 'LBL_PROVINCE_CITY_NAME',
            'type' => 'enum',
            'options'   => 'city_province_dom_c',
          ),
...
, 'relationships' => array (
    ...
    // account contracts
    'account_contracts' => array('lhs_module'=> 'Accounts', 'lhs_table'=> 'accounts', 'lhs_key' => 'id',
