    ...
    <table cellpadding="0" cellspacing="0" width="100%" border="0">
        ...
        <tr>
            <td style="padding-bottom: 2px;">
                ...
                onclick="index.php?action=DetailView&module=Tours&record={$RETURN_ID}&return_module=Tours&return_action=DetailView"
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="tabForm">
            ...
            <tr>
                ...
                <td class="dataField" id="tour_code">{*<span sugar='slot0b'><input type="text" name="tour_code" id="tour_code"
                    ...
                    <input type="text" readonly="readonly" style="width:40px" value="{$TOUR_CODE_AREA}"name="tour_code_area" id="tour_code_area"/>
                    <input type="text" style="width:40px" name="tour_code_num" value="{$TOUR_CODE_NUM}" id="tour_code_num"/>
                    <span>/</span>
                    <input type="text" readonly="readonly" style="width:40px" name="tour_code_department"value="{$TOUR_CODE_DEPARTMENT}" id="tour_code_department"/>
                    {if $IS_TEMPLATE eq 0}
                    <span>-</span>
                ...
                <td class="dataField">
                    <input type="text" id="duration" readonly="readonly" name="duration" size="35" value="{$DURATION}"/>
                </td>
            </tr>
            <tr>
    ...
    <fieldset>
        <table cellpadding="0" cellspacing="0" width="100%" class="table_clone" id="table_clone" maxcount="50">
            ...
            <tbody id="tourprogram_line">
                ...
                <tr id="TR_table_clone_1" class="TR_table_clone">
                    <td>
                        <fieldset>
