...
$mod_strings = array (
  ...
  'LBL_POPUP_SELECT' => 'Tela de Seleção de Usuário',
  'LBL_POPUP_SELECT_DESC' => 'Quando um registro é criado por um usuário em mais de um grupo, um tela de seleção de Grupos de Segurança sobrescreve a herança daquele grupo. Um perfil herdado somente será usado por não-usuários criando registros (por exemplo: workflows, etc).',
