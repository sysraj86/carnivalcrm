...
class ContractCondition extends SugarBean {
	var $db;
	var $field_name_map;
	...
	var $object_name = 'ContractCondition';
	var $table_name = 'contract_conditions';
	
	var $disable_row_level_security = true;
	var $module_dir = 'ContractConditions';
