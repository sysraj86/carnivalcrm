<html>
    <head>
        ...
        <script type="text/javascript" src="{sugar_getjspath file='modules/Tours/jquery.js'}"></script>   
        ...
        <script type="text/javascript" src="{sugar_getjspath file='modules/Worksheets/js/calculate_ob_break.js'}"></script>
        <script type="text/javascript" src="{sugar_getjspath file='modules/Worksheets/js/jquery.table.clone.js'}"></script> 
        ...
        <script type='text/javascript'>
            ...
            Calendar.setup ({ {/literal} inputField : 'ngaytygia', ifFormat : '{$CALENDAR_DATEFORMAT}', showsTime : false, button : 'ngaytygia_trigger', singleClick : true, step : 1 {literal} });addToValidate('EditView', 'expiration', 'date', false,'expiration'  );
        </script>
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
                <tr>
                    ...
                    <td colspan="4"><label></label>&nbsp;
                        ...
                        <input type="button" name="btnTourcode" id="button" value="Select" class="madetour" /></td>
                ...
                <tr>
                    <td height="24" class="dataLabel">Ngày KH</td>
                    <td class="ct_sl1"><input type="text" name="ngaykhoihanh" id="ngaykhoihanh" value="{$NGAYKHOIHANH}" size="10" /></td>

                </tr>
                <tr>
                    <td class="dataLabel">Ngày về</td>
                    <td class="ct_sl1"><input type="text" name="ngayketthuc" value="{$NGAYKETTHUC}" id="ngayketthuc" size="10"/></td>
            ...
            <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
                ...
                <tr>
                    ...
                    <td align="left" class="ct_sl2 dataLabel"><strong>Số lượng FOC cho khách hàng :</strong>
                        <input type="text" name="foc_number" id="foc_number" value="{$FOC_NUMBER}" class="giaban" size="10"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="center" class="ct_sl2"><input type="text" name="TreEm12Tuoi2" value="{$TXTTREEM12TUOI2}" class="giaban calculate" id="TreEm12Tuoi2" size="10"/></td>
                    <td align="center" class="ct_sl2">&nbsp;</td>
                </tr>
                <tr>
                    <td class="dataLabel">Số bữa ăn</td>
                    <td align="center" class="ct_sl1"><input type="text" name="txtSoBuaAn1" value="{$TXTSOBUAAN1}" class="giaban calculate" id="txtSoBuaAn1" size="10"/></td>
                    <td align="center" class="ct_sl2"><input type="text" name="txtSoBuaAn2" value="{$TXTSOBUAAN2}" class="giaban calculate" id="txtSoBuaAn2" size="10"/></td>
                    <td align="center" class="ct_sl2">&nbsp;</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td align="left" class="ct_sl2"><strong>Land 2 trẻ em:</strong>
                ...
                <tr>
                    ...
                    <td align="left" class="ct_sl2">CLTG <input type="text" value="{$TXTCLTG}" class="giaban" name="txtCLTG" id="txtCLTG" size="10"/></td>
                </tr>
                <tr>
                    ...
                    <td class="ct_sl2 dataLabel"></td>
                </tr>
                <tr>
                    <td class="dataLabel">Version</td>
                    <td align="center" class="ct_sl1"><input type="text" name="version" id="version" size="10" value="{$VERSION}"></td>
                    <td align="center" class="ct_sl2 dataLabel">&nbsp;</td>
                    <td class="ct_sl2 dataField">&nbsp;</td>
                </tr>
                <tr>
                    <td class="dataLabel">Ngày Tỷ Giá</td>
                    <td class="dataField ct_sl1" align="center"><input id='ngaytygia' name='ngaytygia' onBlur="parseDate(this, '{$CALENDAR_DATEFORMAT}');"  type="text" tabindex='1' size='15' maxlength='10' value="{$NGAYTYGIA}"/> <img src="themes/default/images/jscalendar.gif" alt="{$APP.LBL_ENTER_DATE}" id="ngaytygia_trigger" align="absmiddle">(dd/mm/yy)   </td>
                    <td align="center" class="ct_sl2 dataLabel">&nbsp;</td>
                    <td class="ct_sl2 dataField">&nbsp;</td>
                </tr>
                <tr>
                    <td class="dataLabel">Tỷ Giá</td>
                    <td class="dataField ct_sl1" align="center"><input type="text" size="10" name="tygia" id="tygia" value="{$TYGIA}"></td>
                    <td align="center" class="ct_sl2 dataLabel">&nbsp;</td>
                    <td class="ct_sl2 dataField">&nbsp;</td>
                </tr>
                <tr>
          ...
          <br>
            <div id="tabs">
                <ul>
                    ...
                    <li><a href="#tabs-7">THU CHI OPTION</a></li>
                </ul>
                <div id="tabs-1">
                    <table>
                ...
                <div id="tabs-2">
                    <table>
                        <tr bgcolor="#6699FF">
                            ...
                            <td align="center" class="dataField"><strong>Ghi Chú</strong></td>
                            <td align="center" class="dataField"><strong>FOC</strong></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input class="calculate giaban" name="focvmbnguoilon" type="text" size="10" id="focvmbnguoilon" value="{$FOCVMBNGUOILON}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichutaxtamtinh" type="text" id="ghichutaxtamtinh" value="{$GHICHUTAXTAMTINH}"></td>
                            <td class="dataField"><input class="calculate giaban" name="foctaxtamtinh" type="text" size="10" id="foctaxtamtinh" value="{$FOCTAXTAMTINH}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichuvmbndnl" type="text" id="ghichuvmbndnl" value="{$GHICHUVMBNDNL}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focvmbndnguoilon" type="text" size="10" id="focvmbndnguoilon" value="{$FOCVMBNDNGUOILON}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichuxedontien" type="text" id="ghichuxedontien" value="{$GHICHUXEDONTIEN}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focxedontien" type="text" size="10" id="focxedontien" value="{$FOCXEDONTIEN}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="chichuvmbte2tuoi" type="text" id="chichuvmbte2tuoi" value="{$GHICHUVMBTE2TUOI}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focvmbteduoi2tuoi" type="text" size="10" id="focvmbteduoi2tuoi" value="{$FOCVMBTEDUOI2TUOI}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichuvmbndte2tuoi" type="text" id="ghichuvmbndte2tuoi" value="{$GHICHUVMBNDTE2TUOI}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focvmbndteduoi2tuoi" type="text" size="10" id="focvmbndteduoi2tuoi" value="{$FOCVMBNDTEDUOI2TUOI}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichuvmbte12tuoi" type="text" id="ghichuvmbte12tuoi" value="{$GHICHUVMBTE12TUOI}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focvmbte12tuoi" type="text" size="10" id="focvmbte12tuoi" value="{$FOCVMBTE12TUOI}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichuvmbndte12tuoi" type="text" id="ghichuvmbndte12tuoi" value="{$GHICHUVMBNDTE12TUOI}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focvmbndte12tuoi" type="text" size="10" id="focvmbndte12tuoi" value="{$FOCVMBNDTE12TUOI}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input class="calculate giaban" name="foctaxte" type="text" size="10" id="foctaxte" value="{$FOCTAXTE}"></td>
                ...
                <div id="tabs-3">
                    <table>
                        ...
                        <tr>
                            <td>LANDFEE 1: 3 sao</td>
                            <td><span class="dataField">
                              <input name="ghichulandfee1_3sao" type="text" id="ghichulandfee1_3sao" value="{$GHICHULANGFEE1_3SAO}">
                            </span></td>
                            <td><span class="dataField">
                              <input class="calculate giaban" name="foclandfee1_3sao" type="text" size="10" id="foclandfee1_3sao" value="{$FOCLANDFEE1_3SAO}">
                            </span></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichulandfee2_3sao" type="text" id="ghichulandfee2_3sao" value="{$GHICHULANDFEE2_3SAO}"></td>
                            <td class="dataField"><input class="calculate giaban" name="foclandfee2_3sao" type="text" size="10" id="foclandfee2_3sao" value="{$FOCLANDFEE2_3SAO}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichulandfee1_4sao" type="text" id="ghichulandfee1_4sao" value="{$GHICHULANDFEE1_4SAO}"></td>
                            <td class="dataField"><input class="calculate giaban" name="foclandfee1_4sao" type="text" size="10" id="foclandfee1_4sao" value="{$FOCLANDFEE1_4SAO}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichulandfee2_4sao" type="text" id="ghichulandfee2_4sao" value="{$GHICHULANDFEE2_4SAO}"></td>
                            <td class="dataField"><input class="calculate giaban" name="foclandfee2_4sao" type="text" size="10" id="foclandfee2_4sao" value="{$FOCLANDFEE2_4SAO}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichuupgrademeal" type="text" id="ghichuupgrademeal" value="{$GHICHUUPGRADEMEAL}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focupgrademeal" type="text" size="10" id="focupgrademeal" value="{$FOCUPGRADEMEAL}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichuoptionaltour" type="text" id="ghichuoptionaltour" value="{$GHICHUOPTIONALTOUR}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focoptionaltour" type="text" size="10" id="focoptionaltour" value="{$FOCOPTIONALTOUR}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichusinglesupp" type="text" id="ghichusinglesupp" value="{$GHICHUSINGLESUPP}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focsinglesupp" type="text" size="10" id="focsinglesupp" value="{$FOCSINGLESUPP}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichulandfete3sao2tuoi" type="text" id="ghichulandfete3sao2tuoi" value="{$GHICHULANDFEETE3SAO2TUOI}"></td>
                            <td class="dataField"><input class="calculate giaban" name="foclandfeete3saoteduoi2tuoi" type="text" size="10" id="foclandfeete3saoteduoi2tuoi" value="{$FOCLANDFEETE3SAOTEDUOI2TUOI}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichulandfeete3sao12tuoi" type="text" id="ghichulandfeete3sao12tuoi" value="{$GHICHULANDFEETE3SAO12TUOI}"></td>
                            <td class="dataField"><input class="calculate giaban" name="foclandfeete3saote12tuoi" type="text" size="10" id="foclandfeete3saote12tuoi" value="{$FOCLANDFEETE3SAOTE12SAO}"></td>
                        ...
                        <tr>
                            <td class="dataLabel"><p>Landfee trẻ em (4 sao) - trẻ em dưới 2 tuổi 
                              
                          </p></td>
                            <td class="dataField"><input name="ghichulandfee4saote2tuoi" type="text" id="ghichulandfee4saote2tuoi" value="{$GHICHULANDFEETE4SAO2TUOI}"></td>
                            <td class="dataField"><input class="calculate giaban" name="foclandfee4saoteduoi2tuoi" type="text" size="10" id="foclandfee4saoteduoi2tuoi" value="{$FOCLANDFEE4SAOTEDUOI2TUOI}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichulandfee4saote12tuoi" type="text" id="ghichulandfee4saote12tuoi" value="{$GHICHULANDFEE4SAOTE12TUOI}"></td>
                            <td class="dataField"><input class="calculate giaban" name="foclandfee4saote12tuoi" type="text" size="10" id="foclandfee4saote12tuoi" value="{$FOCLANDFEETE4SAOTE12TUOI}"></td>
                ...
                <div id="tabs-4">
                    <table>
                        ...
                        <tr>
                            <td class="dataLabel"><b>Visa (Thủ tục thông hành) 
                              
                      </b></td>
                            <td class="dataField"><b>
                              <input name="ghichuvisa" type="text" id="ghichuvisa" value="{$GHICHUVISA}">
                            </b></td>
                            <td class="dataField"><input class="calculate giaban" name="focvisa" type="text" size="10" id="focvisa" value="{$FOCVISA}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichudichthuatcongchung" type="text" id="ghichudichthuatcongchung" value="{$GHICHUDICHTHUATCONGCHUNG}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focdichthuatcongchung" type="text" size="10" id="focdichthuatcongchung" value="{$FOCDICHTHUATCONGCHUNG}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichuchuyenphathoso" type="text" id="ghichuchuyenphathoso" value="{$GHICHUCHUYENPHATHOSO}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focchuyenphat" type="text" size="10" id="focchuyenphat" value="{$FOCCHUYENPHAT}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichuphithumoi" type="text" id="ghichuphithumoi" value="{$GHICHUPHITHUMOI}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focchiphimoi" type="text" size="10" id="focchiphimoi" value="{$FOCCHIPHIMOI}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichuphivisate2tuoi" type="text" id="ghichuphivisate2tuoi" value="{$GHICHUPHIVISATE2TUOI}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focphivisate2tuoi" type="text" size="10" id="focphivisate2tuoi" value="{$FOCPHIVISA2TUOI}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichuphivisate12tuoi" type="text" id="ghichuphivisate12tuoi" value="{$GHICHUPHIVISATE12TUOI}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focchiphivisate12tuoi" type="text" size="10" id="focchiphivisate12tuoi" value="{$FOCPHIVISATE12TUOI}"></td>
                ...
                <div id="tabs-5">
                    <table>
                        <tr bgcolor="#6699FF">
                            ...
                            <td align="center" class="dataField"><strong>FOC</strong></td>
                            <td>&nbsp;</td>
                            <td colspan="6" align="right"><input name="sumguide1" type="text" class="disable tinhtoan" id="sumguide1" value="{$SUMGUIDE1}" /></td>
                            <td>&nbsp;</td>
                            <td colspan="6" align="right"><input name="sumguide2" type="text" class="disable tinhtoan" id="sumguide2" value="{$SUMGUIDE2}" /></td>
                        </tr>
                        <tr>
                            <td class="dataLabel">Tour leader                      </td>
                            <td class="dataField"><input name="ghichutourleader" type="text" id="ghichutourleader" value="{$GHICHUTOURLEADER}"></td>
                            <td class="dataField"><input class="calculate giaban" name="foctourleader" type="text" size="10" id="foctourleader" value="{$FOCTOURLEADER}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichuchiphikhac" type="text" id="ghichuchiphikhac" value="{$GHICHUCHIPHIKHAC}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focchiphikhac" type="text" size="10" id="focchiphikhac" value="{$FOCCHIPHIKHAC}"></td>
                ...
                <div id="tabs-6">
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichubaohiem" type="text" id="ghichubaohiem" value="{$GHICHUBAOHIEM}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focbaohiem" type="text" size="10" id="focbaohiem" value="{$FOCBAOHIEM}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichubaohiemte2tuoi" type="text" id="ghichubaohiemte2tuoi" value="{$GHICHUBAOHIEMTE2TUOI}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focbaohiemteduoi2tuoi" type="text" size="10" id="focbaohiemteduoi2tuoi" value="{$FOCBAOHIEMTEDUOI2TUOI}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichubaohiemte12tuoi" type="text" id="ghichubaohiemte12tuoi" value="{$GHICHUBAOHIEMTE12TUOI}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focbaohiemte12tuoi" type="text" size="10" id="focbaohiemte12tuoi" value="{$FOCBAOHIEMTE12TUOI}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input class="calculate giaban" name="foctip" type="text" size="10" id="foctip" value="{$FOCTIP}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input class="calculate giaban" name="focquatang" type="text" size="10" id="focquatang" value="{$FOCQUATANG}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input class="calculate giaban" name="focland2" type="text" size="10" id="focland2" value="{$FOCLAND2}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input class="calculate giaban" name="foccpk" type="text" size="10" id="foccpk" value="{$FOCCPK}"></td>
                        ...
                        <tr>
                            ...
                            <td class="dataField"><input name="ghichuchenhlachtygia" type="text" id="ghichuchenhlachtygia" value="{$GHICHUCHENHLECHTYGIA}"></td>
                            <td class="dataField"><input class="calculate giaban" name="focchenhlechtygia" type="text" size="10" id="focchenhlechtygia" value="{$FOCCHENHLECHTYGIA}"></td>
                        ...
                        <tr>
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td colspan="9">
                                            <table width="100%" border="1" style="border-collapse:collapse;" cellspacing="0" cellpadding="0" class="table_clone" id="thu_option">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                        <td><input type="text" name="tongtien_thu" class="disable tinhtoan" id="tongtien_thu" value="{$TONGTIEN_THU}" size="20"/></td>
                                                        <td>&nbsp;</td>
                                                        <td><input type="text" name="tongtien_thu1" class="disable tinhtoan" id="tongtien_thu1" value="{$TONGTIEN_THU1}" size="20"/></td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                </thead>
                                                ...
                                                {if $ID eq '' or $COUNTTHUOPTION eq 0} 
                                                    <tr>
                                                        <td><input type="text" name="thu_dichvu[]" id="thu_dichvu" class="thuoption" size="50"></td>
                                                        <td><input type="text" name="thu_soluong[]" id="thu_soluong" class="thuoption numbers" size="15"></td>
                                                        <td><input type="text" name="textfield3" id="textfield3" class="thuoption x" size="5" value="X"></td>
                                                        <td><input type="text" name="thu_dongia[]" id="thu_dongia" class="thuoption numbers"  size="15"></td>
                                                        <td><input type="text" name="thu_thanhtien[]" id="thu_thanhtien" class="thuoption numbers" size="15"></td>
                                                        <td><input type="text" name="thu_dongiamot[]" id="thu_dongiamot" class="thuoption numbers" size="15"></td>
                                                        <td><input type="text" name="thu_thanhtienmot[]" id="thu_thanhtienmot" class="thuoption numbers" size="15"></td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                    </tr>
                                                {/if}
                        ...
                        <tr>
                            <td>
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        <td colspan="9">
                                            <table width="100%" border="1" style="border-collapse: collapse;" cellspacing="0" cellpadding="0" class="table_clone" id="chi_option">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                        <td><input type="text" name="tongtien_chi" id="tongtien_chi" class="disable tinhtoan" value="{$TONGTIEN_CHI}" size="20"/></td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
                                                ...
                                                {if $ID eq '' or $COUNTCHIOPTION eq 0}   
                                                    <tr>
                                                        <td><input type="text" name="chi_dichvu[]" id="chi_dichvu" class="chioption" size="50"></td>
                                                        <td><input type="text" name="chi_soluong[]" id="chi_soluong" class="chioption numbers" size="15"></td>
                                                        <td><input type="text" name="textfield3" id="textfield3" class="chioption x" size="5" value="X"></td>
                                                        <td><input type="text" name="chi_dongia[]" id="chi_dongia" class="chioption numbers"  size="15"></td>
                                                        <td><input type="text" name="chi_thanhtien[]" id="chi_thanhtien" class="chioption numbers" size="15"></td>
                                                        <td>&nbsp;</td>
                                                        <td>&nbsp;</td>
            ...
            <div id="tabs-9">
                <table cellpadding="0" cellspacing="0" border="1" style="border-collapse: collapse;" width="100%">
                    ...
                    <tr>
                        ...
                        <td  class="ct_sl2"><input type="text" class="disable" name="tongchi1" id="tongchi1" value="{$TONGCHI1}" size="10"/></td>
                        <td  class="ct_sl2"><input type="text" class="disable" name="tongchi2" id="tongchi2" value="{$TONGCHI2}" size="10"/></td>
                        <td  class="ct_sl3"><input type="text" class="disable" name="tongchi3" id="tongchi3" value="{$TONGCHI3}" size="10"/></td>
                        <td  class="ct_sl3"><input type="text" class="disable" name="tongchi4" id="tongchi4" value="{$TONGCHI4}" size="10"/></td>
                        <td  class="ct_sl3"><input type="text" class="disable" name="tongchi5" id="tongchi5" value="{$TONGCHI5}" size="10"/></td>
                        <td  class="ct_sl3"><input type="text" class="disable" name="tongchi6" id="tongchi6" value="{$TONGCHI6}" size="10"/></td>
                        <td>&nbsp;</td>
                        <td  class="ct_sl2"><input type="text" class="disable" name="tongchi7" id="tongchi7" value="{$TONGCHI7}" size="10"/></td>
                        <td  class="ct_sl2"><input type="text" class="disable" name="tongchi8" id="tongchi8" value="{$TONGCHI8}" size="10"/></td>
                        <td  class="ct_sl3"><input type="text" class="disable" name="tongchi9" id="tongchi9" value="{$TONGCHI9}" size="10"/></td>
                        <td  class="ct_sl3"><input type="text" class="disable" name="tongchi10" id="tongchi10" value="{$TONGCHI10}" size="10"/></td>
                        <td  class="ct_sl3"><input type="text" class="disable" name="tongchi11" id="tongchi11" value="{$TONGCHI11}" size="10"/></td>
                        <td  class="ct_sl3"><input type="text" class="disable" name="tongchi12" id="tongchi12" value="{$TONGCHI12}" size="10"/></td>
                    </tr>
                    <tr>
