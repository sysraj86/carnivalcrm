...
<form action="index.php"  name="EditView" id="EditView" method="post">
    ...
    <table cellpadding="0" cellpadding="0" border="0" width="100%" class="tabForm">
        ...
        <tr>
            ...
            <td class="dataField"><input id='date_of_contracts' name='date_of_contracts' value="{$DATE_OF_CONTRACTS}" onblur="parseDate(this, '{$CALENDAR_DATEFORMAT}');"  type="text" tabindex='1' size='15' maxlength='10' value="{$DATE_OF_CONTRACTS}"/> <img src="themes/default/images/jscalendar.gif" alt="{$APP.LBL_ENTER_DATE}" id="date_of_contract_trigger" align="absmiddle"> (dd/mm/yy) </td>
...
<!--                <input title="{$APP.LBL_CLEAR_BUTTON_TITLE}" accessKey="{$APP.LBL_CLEAR_BUTTON_KEY}" type="button" tabindex='2' class="button" name="btn_parent_name_clear" id="btn_parent_name_clear" value="{$APP.LBL_CLEAR_BUTTON_LABEL}" onclick="this.form.parent_name.value='', this.form.parent_id.value='';"/>  -->
        ...
        <td class="dataField"><input type="text" name="guider_type" id="guider_type" size="40" value="{$GUIDER_TYPE}"/></td>
        <td class="dataLabel">Số thẻ</td>
        <td class="dataField"><input type="text" id="guide_card_no" name="guide_card_no" value="{$GUIDE_CARD_NO}"/></td>
        </tr>        
    ...
    <!--            <input title="{$APP.LBL_CLEAR_BUTTON_TITLE}" accessKey="{$APP.LBL_CLEAR_BUTTON_KEY}" type="button" tabindex='2' class="button" name="btn_parent_name_clear" id="btn_parent_name_clear" value="{$APP.LBL_CLEAR_BUTTON_LABEL}" onclick="this.form.daidienbenb_name.value='';"/>-->
        ...
        <tr class="hochieukhachle">
            ...
            <td class="dataField">
            <input id='ngaycaphochieu' name='ngaycaphochieu' onblur="parseDate(this, '{$CALENDAR_DATEFORMAT}');"  type="text" tabindex='1' size='15' maxlength='10' value="{$NGAYCAPHOCHIEU}"/> <img src="themes/default/images/jscalendar.gif" alt="{$APP.LBL_ENTER_DATE}" id="ngaycaphochieu_trigger" align="absmiddle"> (dd/mm/yy) </td>
        </tr>
        <tr>
            <td class="dataLabel"> Địa chỉ:</td>                    
        ...
        <tr> 
            <td class="dataLabel travelguide" {if !($PARENT eq 'Transports')} style="display: none;" {/if}>Ngày cấp</td>
            <td class="dataField travelguide" {if !($PARENT eq 'Transports')} style="display: none;" {/if}><input type="text" name="date_issued_guide" id="date_issued_guide" value="{$DATE_ISSUED}"/></td>
            <td class="dataLabel">Điện thoại:</td>
    ...
    <div>
        <!-- hợp đồng thuê xe -->
        <table class="hopdongthuexe tabForm" {if !($PARENT eq 'Transports')}  style="display: none;" {/if}cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
            <td class="dataLabel" colspan="6"><h2>NỘI DUNG HỢP ĐỒNG</h2></td>
        </tr>
        <tr>
            <td colspan="6">
                <table cellpadding="0" id="hopdongthuexe" class="table_clone" cellspacing="0" border="1" style="border-collapse: collapse;" width="100%">
                    ...
                    <tbody>
                        {if $ID eq '' or $TRANSPORTCOUNT eq 0}
                        <tr>
                            <td align="center"> <input type="text" name="loaixe[]" id="loaixe" value=""/>  </td>
                            <td align="center"><input type="text" name="soxe[]" id="soxe" value=""/></td>
                            <td align="center"><input type="text" name="lotrinh[]" id="lotrinh" value=""/></td>
                            <td align="center"><input type="text" name="thoigiansudung[]" id="thoigiansudung" value=""/></td>
                            <td align="center"><input type="text" name="dongia[]" id="dongia" value=""/><input type="hidden" name="transport_id" id="transport_id" value=""/><input type="hidden" class="deleted" id="deleted" name="deleted[]" value="0"/></td>
                            <td align="center"> 
        ...
        <tr>
            <td colspan="5" align="center" class="dataLabel">Tổng cộng</td>
            <td class="dataField"><input type="text" name="giatrihopdongxe" id="giatrihopdongxe" value="{$GIATRIHOPDONGXE}"/></td>
        </tr>
        </table> 
        <table class="hopdongthuexe tabForm" cellpadding="0" cellspacing="0" border="0" width="100%">
            ...
            <tr>
                <td class="dataLabel">Bên B thanh toán chuyển khoản cho bên A </td>
                <td class="dataField"><input type="text" name="hopdongthuexe_percent" id="hopdongthuexe_percent" value="{$HOPDONGTHUEXE_PERCENT}">%</td>
            </tr>
            <tr>
                <td class="dataLabel">Bằng chữ</td>
                <td class="dataField"><input type="text" name="hopdongthuexe_inword" size="70" id="hodongthuexe_inword" value="{$HOPDONGTHUEXE_INWORD}"/></td>
            </tr>
        </table>
...
<!--                <input title="{$APP.LBL_SELECT_BUTTON_TITLE}" accessKey="{$APP.LBL_SELECT_BUTTON_KEY}" type="button" tabindex='2' class="button" value="{$APP.LBL_CLEAR_BUTTON_LABEL}" onclick="this.form.groupprogracontracts_name.value=''; this.form.groupprogr4251rograms_ida.value='';";/> -->
                ...
                <td class="travelguide dataLabel" {if !($PARENT eq 'TravelGuides')} style="display: none;" {/if}>Số lượng khách</td>
                <td class="travelguide dataField" {if !($PARENT eq 'TravelGuides')} style="display: none;">{/if}<input type="text" id="num_of_cus_guide" name="num_of_cus_guide" value="{$NUM_OF_CUS_GUIDE}"/></td>
            </tr>
            <tr>
        ...
        <table class="tabForm travelguide" {if !($PARENT eq 'TravleGuides')}  style="display: none;" {/if} cellpadding="0" cellspacing="0" border="0" width="100%">
        <tr>
            <td colspan="4"><h2>TRÁCH NHIỆM BÊN A</h2></td>
        </tr>
        <tr>
            <td class="dataLabel">Giá trị hợp đồng</td>
            <td class="dataField"><input type="text" name="contract_guide_cost" id="contract_guide_cost" value="{$CONTRACT_GUIDE_COST}"/></td>
            <td class="dataLabel">Bằng chữ</td>
            <td class="dataField"><input type="text" name="guide_inword" id="guide_inword" size="70" readonly="readonly" value="{$GUIDE_INWORD}"></td>
        </tr>
        </table>

        <div class="hopdongdichvu" {if !($PARENT eq 'Accounts' or $PARENT eq 'FITs' or $PARENT eq 'Restaurants' or $PARENT eq 'Hotels')} style="display:none"{/if}>
