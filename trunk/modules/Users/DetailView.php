...
/**
* Them loai Sale cho nhan vien, loai gom Sale hoac Telesaleas
* Sua lai loai Deparment thanh enum
*  Le Gia Thanh
* @var Sugar_Smarty
*/
if($focus->department != null){
    $sugar_smarty->assign('DEPARTMENT', translate('deparment_dom','',$focus->department));
}else{
    $sugar_smarty->assign('DEPARTMENT','');  
}

if($focus->type_sale != null){
    $sugar_smarty->assign('TYPE_SALE', translate('user_typesale_dom','',$focus->type_sale));
}else{
...
$location = translate('user_location_dom','',$focus->location);
