        ...
        <div>
            ...
            <table width="100%" border="0" cellspacing="1" cellpadding="0" class="edit view">
                          ...
                          <!--      <input name='department' type="text"  size='25' maxlength='100' value='{$DEPARTMENT}' > -->
                            ...
                            <tr>
                                <td scope="row"><slot>{$MOD.LBL_TYPE_SALE}:</slot></td>
                                <td  ><slot>
                                <select name="type_sale" id="type_sale" tabindex='5' {$IS_ADMIN_DISABLED} >{$TYPE_SALE}</select>
                                <!--<input name='type_sale' type="text" tabindex='6' size='20' maxlength='25' value='{$TYPE_SALE}'>-->
                                </slot></td>
