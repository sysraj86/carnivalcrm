						...
						<div class="login">
							<form action="index.php" method="post" name="DetailView" id="form" onsubmit="return document.getElementById('cant_login').value == ''">
								...
								{/if}
                                    ...
                                    <tr><td>&nbsp;</td></tr>
									<tr>
										<td scope="row" width="40%">{sugar_translate module="Users" label="LBL_USER_NAME"}:</td>
										<td width="60%"><input type="text" size='35' tabindex="1" id="user_name" name="user_name"  value='{$LOGIN_USER_NAME}' /></td>
									</tr>
									<tr>
										...
										<div  style="cursor: hand; cursor: pointer; display:{$DISPLAY_FORGOT_PASSWORD_FEATURE};" onclick='toggleDisplay("forgot_password_dialog");'>
											...
											<div id="forgot_password_dialog" style="display:none" >
												...
												<table cellpadding="0" cellspacing="2" border="0" align="center" width="100%" >
													...
													<tr>
														<td scope="row" width="40%">{sugar_translate module="Users" label="LBL_USER_NAME"}:</td>
														<td width="60%"><input type="text" size='26' id="fp_user_name" name="fp_user_name"  value='{$LOGIN_USER_NAME}' /></td>
													</tr>
													<tr>
											            <td scope="row" width="40%">{sugar_translate module="Users" label="LBL_EMAIL"}:</td>
											            <td width="60%"><input type="text" size='26' id="fp_user_mail" name="fp_user_mail"  value='' ></td>
											     	</tr>
													{$CAPTCHA}
													<tr>
													    <td scope="row" width="40%"><div id='wait_pwd_generation'></div></td>
														<td width="60%"><input title="Email Temp Password" class="button" type="button" style="display:inline" onclick="validateAndSubmit(); return document.getElementById('cant_login').value == ''" id="generate_pwd_button" name="fp_login" value="{sugar_translate module="Users" label="LBL_LOGIN_SUBMIT"}"></td>
													</tr>
												</table>
											</div>
										</td>
