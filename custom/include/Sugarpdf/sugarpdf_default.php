<?php
    $sugarpdf_default['PDF_MARGIN_TOP'] = 25;
    $sugarpdf_default['PDF_MARGIN_RIGHT'] = 15;
    $sugarpdf_default['PDF_MARGIN_BOTTOM'] = 25;
    $sugarpdf_default['PDF_MARGIN_LEFT'] = 20;
    $sugarpdf_default['PDF_PAGE_FORMAT'] = 'A4';
    $sugarpdf_default['PDF_PAGE_ORIENTATION'] = 'P';
    $sugarpdf_default['PDF_FONT_NAME_MAIN'] = 'freeserif';
    $sugarpdf_default['PDF_FONT_NAME_DATA'] = 'freeserif';
    
    
    // THAM SO MAC DINH TRONG FILE include/Sugarpdf/sugarpdf_default.php, CAN OVERRIDE THUOC TINH NAO THI LAY LEN TREN
    /*
