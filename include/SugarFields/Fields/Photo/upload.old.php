...
elseif( empty($_GET['field']) ){
   ...
   // $seed->retrieve($_GET['id']);
    ...
    if($seed->ACLAccess('edit')){
        ...
        $new_name = $module_name.'_'.$field_name.'_'.$time.'.jpg';
        ...
        if (    
            ...
            if ($_FILES["file"]["error"] > 0){
        	    ...
        	    if (file_exists("phpThumb/images/" . $new_name)){
                    ...
                    $t = time();
                    $temp = '<img src="custom/SynoFieldPhoto/phpThumb/phpThumb.php?src=images/new_' . $new_name . '&h=80&w=80&t='.$t.'">';
        		    echo   $temp;
                    echo $t;
        	    }
            }
