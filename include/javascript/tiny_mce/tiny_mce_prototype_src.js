...
(function () {
    ...
    tinymce.extend(tinymce, {
        ...
        inArray:function (a, v) {
            return a && a.indexOf ? a.indexOf(v) : -1;
        }
    });
    ...
    tinymce.Formatter = function (ed) {
        ...
        function apply(name, vars, node) {
            ...
            function applyStyleToList(node, bookmark, wrapElm, newWrappers, process) {
                ...
                each(node.childNodes, function (n, index) {
                    if (n.nodeName === "SPAN" && dom.getAttrib(n, "data-mce-type") == "bookmark" && n.id == bookmark.id + "_start") {
                        startIndex = index
                    }
                    if (n.nodeName === "SPAN" && dom.getAttrib(n, "data-mce-type") == "bookmark" && n.id == bookmark.id + "_end") {
                        endIndex = index
                    }
                });
