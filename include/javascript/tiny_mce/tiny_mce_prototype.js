(function (d) {
    ...
    var b = {majorVersion:"3", minorVersion:"4.4", releaseDate:"2011-08-04", _init:function () {
...
(function () {
    ...
    tinymce.extend(tinymce, {trim:function (b) {
        return b ? b.strip() : ""
...
(function (b) {
    ...
    b.create("tinymce.util.Quirks", {Quirks:function (c) {
        if (b.isWebKit) {
            a(c)
        }
    }})
...
(function (m) {
    ...
    m.html.Schema = function (q) {
            ...
            if (H) {
                ...
                for (G = 0, C = H.length; G < C; G++) {
                    ...
                    if (B) {
                        ...
                        K = {};
                        F = [];
                        E = {attributes:K, attributesOrder:F};
                        if (S === "#") {
                            E.paddEmpty = true
                        }
                        if (S === "-") {
                                ...
                                if (B) {
                                    ...
                                    if (S) {
                                        if (S === "=") {
                                            ...
                                            E.attributesDefault.push({name:U, value:P});
                                            Q.defaultValue = P
                                        }
                                        if (S === ":") {
                                            E.attributesForced = E.attributesForced || [];
                                            E.attributesForced.push({name:U, value:P});
                                            Q.forcedValue = P
                                        }
                                        if (S === "<") {
                                            Q.validValues = d(P, "?")
        ...
        if (!q.valid_elements) {
            k(h, function (B, A) {
                n[A] = {attributes:B.attributes, attributesOrder:B.attributesOrder};
                o[A] = B.children
            });
...
(function (m) {
    ...
    m.create("tinymce.Editor", {Editor:function (r, q) {
        ...
        r = n.add(q.iframeContainer, "iframe", {id:H.id + "_ifr", src:F || 'javascript:""', frameBorder:"0", allowTransparency:"true", title:I.aria_label, style:{width:"100%", height:A}});
        ...
        q.formatter.register({alignleft:[
...
(function (c) {
    ...
    c.EditorCommands = function (n) {
        ...
        t({"mceResetDesignMode,mceBeginUndoLevel":function () {
            ...
            D = p.getNode();
            F = {context:D.nodeName.toLowerCase()};
            E = x.parse(J, F);
            z = E.lastChild;
