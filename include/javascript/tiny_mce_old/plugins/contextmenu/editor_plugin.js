(function () {
    ...
    tinymce.create('tinymce.plugins.ContextMenu', {init:function (ed) {
        var t = this;
        t.editor = ed;
        ...
        m = ed.controlManager.createDropMenu('contextmenu', {offset_x:p1.x + ed.getParam('contextmenu_offset_x', 0), offset_y:p1.y + ed.getParam('contextmenu_offset_y', 0), constrain:1});
        t._menu = m;
