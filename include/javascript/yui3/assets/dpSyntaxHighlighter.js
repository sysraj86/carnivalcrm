...
dp.sh.Utils.Expand = function (sender) {
    ...
    table.parentNode.style.height = '100%';
}
...
dp.sh.Utils.PrintSource = function (sender) {
    ...
    var doc = null;
    var wnd = iframe.style.cssText = 'position:absolute; width:0px; height:0px; left:-5px; top:-5px;';
...
dp.sh.Brushes.CSS = function () {
    ...
    this.regexList = [
        ...
        {regex:new RegExp(this.GetValuesCSS(values), 'gm'), css:'value'},
