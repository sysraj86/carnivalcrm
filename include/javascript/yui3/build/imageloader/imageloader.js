...
YUI.add('imageloader', function (Y) {
    ...
    Y.ImgLoadGroup.ATTRS = {name:{value:''}, timeLimit:{value:null}, foldDistance:{validator:Y.Lang.isNumber, setter:function (val) {
        this._setFoldTriggers();
        return val;
    }, lazyAdd:false}, className:{value:null, setter:function (name) {
        this._className = name;
        return name;
    }, lazyAdd:false}};
    var groupProto = {_init:function () {
        this._triggers = [];
        this._imgObjs = {};
        this._timeout = null;
        ...
        var allFetched = true, viewReg = Y.DOM.viewportRegion(), hLimit = viewReg.bottom + this.get('foldDistance'), id, imgFetched, els, i, len;
        ...
        if (this._className) {
            if (this._classImageEls === null) {
                ...
                els.each(function (node) {
                    this._classImageEls.push({el:node, y:node.getY(), fetched:false});
                }, this);
            }
    ...
    Y.ImgLoadImgObj.ATTRS = {domId:{value:null, writeOnce:true}, bgUrl:{value:null}, srcUrl:{value:null}, width:{value:null}, height:{value:null}, setVisible:{value:false}, isPng:{value:false}, sizingMethod:{value:'scale'}, enabled:{value:'true'}};
    var imgProto = {_init:function () {
        this._fetched = false;
        this._imgEl = null;
        this._yPos = null;
