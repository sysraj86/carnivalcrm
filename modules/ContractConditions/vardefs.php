...
$dictionary['ContractCondition'] = array(
...
'fields' => array (
  ...
  'contract_condition_id' => array(
    'name'     => 'contract_condition_id',
    'vname'    => '',
    'type'     => 'id',
    'required' => true,
  ),
  
   'contract_phase'      => array(
        'name'      => 'contract_phase',
        'vname'     => '',
        'type'      => 'varchar',
        'len'       => 50
...
'indices' => array (
       array('name' =>'contract_condition_spk', 'type' =>'primary', 'fields'=>array('id')),
      )
);
