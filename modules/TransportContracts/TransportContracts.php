...
class TransportContracts extends SugarBean {
	var $db;
	var $field_name_map;
	...
	var $object_name = 'TransportContracts';
	var $table_name = 'transportcontracts';
	
	var $disable_row_level_security = true;
	var $module_dir = 'TransportContracts';
	var $field_defs = array();
	var $field_defs_map = array();
	var $new_schema = true;	// Do not actually declare, use the functions statically
