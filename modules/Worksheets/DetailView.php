<?php
    ...
    $GLOBALS['log']->info("Worksheets detail view");
    ...
    $ss->assign('TXRTREEM2TUOI1',$noidung->TreEm2Tuoi1);
    ...
    $THUOPTION = $noidung->thuoption;
        ...
        $ThuHtml = '';
            foreach($THUOPTION as $val){
                $ThuHtml .= '<tr>';
                $ThuHtml .= '<td class="tabDetailViewDL">'.$val->thu_dichvu.'</td>';
                $ThuHtml .= '<td class="tabDetailViewDF">'.$val->thu_soluong.'</td>';
                $ThuHtml .= '<td class="tabDetailViewDF">X</td>';
                $ThuHtml .= '<td class="tabDetailViewDF">'.$val->thu_dongia.'</td>';
                $ThuHtml .= '<td class="tabDetailViewDF">'.$val->thu_thanhtien.'</td>';
                $ThuHtml .= '<td class="tabDetailViewDF">'.$val->thu_dongiamot.'</td>';
                $ThuHtml .= '<td class="tabDetailViewDF">'.$val->thu_thanhtienmot.'</td>';
                $ThuHtml .= '</tr>';
            }
        ...
        $ChiHtml = '';
            foreach($CHIOPTION as $chioption){
                $ChiHtml .= '<tr>';
                $ChiHtml .= '<td class="tabDetailViewDL">'.$chioption->chi_dichvu.'</td>';
                $ChiHtml .= '<td class="tabDetailViewDF">'.$chioption->chi_soluong.'</td>';
                $ChiHtml .= '<td class="tabDetailViewDF">X</td>';
                $ChiHtml .= '<td class="tabDetailViewDF">'.$chioption->chi_dongia.'</td>';
                $ChiHtml .= '<td class="tabDetailViewDF">'.$chioption->chi_thanhtien.'</td>';
                $ChiHtml .= '</tr>';
            }
    ...
    $tpl = 'modules/Worksheets/tpls/DetailView/'.$focus->type.'.tpl';
    $ss->display($tpl);
?>
