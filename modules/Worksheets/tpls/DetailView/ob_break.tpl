...
<table border="1" style="border-collapse: collapse;" width="100%" cellpadding="0" cellspacing="0">  
    <tr>
        <td colspan="7" class="tr_color"><h3>THU OPTION</h3> </td>
    </tr>
    <tr>
        <td class="tabDetailViewDL"><strong>TỔNG THU OPTIONS</strong></td>
        <td class="tabDetailViewDF">&nbsp;</td>
        <td class="tabDetailViewDF">&nbsp;</td>
        <td class="tabDetailViewDF">&nbsp;</td>
        <td class="tabDetailViewDF">{$TONGTIEN_THU}</td>
        <td class="tabDetailViewDF">&nbsp;</td>
        <td class="tabDetailViewDF">{$TONGTIEN_THU1}</td>
    </tr>
    {$THUHTML}
</table>
<!-- Land fee  -->
<table border="1" style="border-collapse: collapse;" width="100%" cellpadding="0" cellspacing="0">
    <tr>
        <td colspan="11" class="tabDetailViewDF tr_color"><b>CHI</b></td>
    </tr>
    <tr bgcolor="#6699FF">
...
<table cellpadding="0" cellspacing="0" border="1" style="border-collapse: collapse;" width="100%" class="tabDetailView">   
    <tr>
        <td class="tr_color" colspan="5"><h3>CHI OPTION</h3></td>
    </tr>
    <tr>
        <td class="tabDetailViewDL"><strong>TỔNG CHI OPTIONS</strong></td>
        <td class="tabDetailViewDF">&nbsp;</td>
        <td class="tabDetailViewDF">&nbsp;</td>
        <td class="tabDetailViewDF">&nbsp;</td>
        <td class="tabDetailViewDF">{$TONGTIEN_CHI}</td>
    </tr>
    {$CHIHTML}
</table>
<table cellpadding="0" cellspacing="0" border="1" style="border-collapse: collapse;" width="100%" class="tabDetailView">
