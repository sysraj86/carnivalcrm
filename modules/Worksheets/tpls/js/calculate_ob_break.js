...
function thuchioption(){
   id = this.id.substring(this.id.length-1, this.id.length);
   $('#chi_thanhtien'+id).val(Math.round(parseFloat($('#chi_soluong'+id).val())*parseFloat($('#chi_dongia'+id).val())).toFixed(2));
   $('#chi_thanhtienmot'+id).val(Math.round(parseFloat($('#chi_soluong'+id).val())*parseFloat($('#chi_dongiamot'+id).val())).toFixed(2));
   $('#thu_thanhtienmot'+id).val(Math.round(parseFloat($('#thu_soluong'+id).val())*parseFloat($('#thu_dongiamot'+id).val())).toFixed(2));
   $('#thu_thanhtien'+id).val(Math.round(parseFloat($('#thu_soluong'+id).val())*parseFloat($('#thu_dongia'+id).val())).toFixed(2));
}
...
function tinhtongthuoption(){
    ...
    var sum1= 0;
    for(i=1;i<=count;i++){
        var tt = parseFloat($('#thu_thanhtien'+i).val());
        var tt1 = parseFloat($('#thu_thanhtienmot'+i).val());
        sum += tt;
        sum1 += tt1;
    }
...
function tinhtongchioption(){
   ...
   var sum = 0;
    for(i=1;i<=count;i++){
        var tt = parseFloat($('#chi_thanhtien'+i).val());
        sum += tt;
    }
...
function getvaluevanchuyen(){
    ...
    // get value bên phái
    // phan van chuyen
    $('#vmbnguoilon5').val($('#NguoiLon2').val()- parseFloat($('#focvmbnguoilon').val()));
    ...
    // bên trái
    $('#vmbtreem2tuoi3').val(Math.round($('#vmbnguoilon3').val()*(parseFloat($('#focvmbteduoi2tuoi').val())/100)).toFixed(2));
    $('#vmbtreem12tuoi3').val(Math.round($('#vmbnguoilon3').val()*(parseFloat($('#focvmbte12tuoi').val())/100)).toFixed(2));
    ...
    // bên phải
    $('#vmbtreem2tuoi7').val(Math.round($('#vmbnguoilon7').val()*(parseFloat($('#focvmbteduoi2tuoi').val())/100)).toFixed(2));
    $('#vmbtreem12tuoi7').val(Math.round($('#vmbnguoilon7').val()*(parseFloat($('#focvmbte12tuoi').val())/100)).toFixed(2));
...
function calculator(){
    ...
    else{$('#chenhlechtygia8').val(Math.round(tygia4sao1 * (parseFloat($('#txtCLTG').val())/100)).toFixed(2));}
...
function tinhtongchiphi(){
    ...
    // tong chi ks3* nguoi lon 
     if(parseFloat($('#landfee1_3_4').val())+parseFloat($('#landfee_2_3_4').val())> 0){
        var tongcongchi = parseFloat($('#tongchivanchuyen1').val()) + parseFloat($('#sumlandfeepackage1').val()) + parseFloat($('#sumvisa1').val()) + parseFloat($('#sumguide1').val()) + parseFloat($('#sumotherservice1').val())+parseFloat($('#tongtien_chi').val());
        var giaban; 
        if(parseFloat($('#giaban6').val())> parseFloat($('#giaban5').val())){
            giaban = ((parseFloat($('#tongthunguoilon2').val())+parseFloat($('#tongthute2').val()))-(parseFloat($('#tongthunguoilon1').val())+parseFloat($('#tongthute1').val())))* (parseFloat($('#txtCLTG').val()/100 ));
        }
        else {giaban = 0;}
   ...
   if(parseFloat($('#treem12tuoi7').val())>0){
    ...
    if(parseFloat($('#landfee1_3_8').val())+parseFloat($('#landfee_2_3_8').val()) > 0){
        ...
        if(parseFloat($('#giaban12').val())>parseFloat($('#giaban11').val())){ 
            giaban1 = ((parseFloat($('#tongthunguoilon4').val())+parseFloat($('#tongthute4').val()))-(parseFloat($('#tongthunguoilon3').val())+parseFloat($('#tongthute3').val())))* (parseFloat($('#txtCLTG').val())/100); 
        }
        else{giaban1 = 0;}
...
function chiphidichvukhac(){
   ...
   // var baohiemtreem2tuoi1 = parseFloat($('#baohiemtreem2tuoi4').val());
    ...
    // land 2
    var land2_1 = parseFloat($('#land2_4').val());
    // CPK
...
function reportsummary(){
    ...
    // lãi khách
    $('#laikhach1').val(parseFloat($('#giaban1').val())-parseFloat($('#gianet1').val()));
    $('#laikhach2').val(parseFloat($('#giaban2').val())-parseFloat($('#gianet2').val()));
    $('#laikhach3').val(parseFloat($('#giaban3').val())-parseFloat($('#gianet3').val()));
    $('#laikhach4').val(parseFloat($('#giaban4').val())-parseFloat($('#gianet4').val()));
    $('#laikhach5').val(parseFloat($('#giaban5').val())-parseFloat($('#gianet5').val()));
    $('#laikhach6').val(parseFloat($('#giaban6').val())-parseFloat($('#gianet6').val()));
    $('#laikhach7').val(parseFloat($('#giaban7').val())-parseFloat($('#gianet7').val()));
    $('#laikhach8').val(parseFloat($('#giaban8').val())-parseFloat($('#gianet8').val()));
    $('#laikhach9').val(parseFloat($('#giaban9').val())-parseFloat($('#gianet9').val()));
    $('#laikhach10').val(parseFloat($('#giaban10').val())-parseFloat($('#gianet10').val()));
    $('#laikhach11').val(parseFloat($('#giaban11').val())-parseFloat($('#gianet11').val()));
    $('#laikhach12').val(parseFloat($('#giaban12').val())-parseFloat($('#gianet12').val()));
    
    // tổng lãi
    $('#tonglai1').val(parseFloat($('#treem2tuoi3').val())-parseFloat($('#tongchi1').val()));
    $('#tonglai2').val(parseFloat($('#treem2tuoi5').val())-parseFloat($('#tongchi2').val()));
    $('#tonglai3').val(parseFloat($('#treem12tuoi3').val())-parseFloat($('#tongchi3').val()));
    $('#tonglai4').val(parseFloat($('#treem12tuoi5').val())-parseFloat($('#tongchi4').val()));
    $('#tonglai4').val(parseFloat($('#treem12tuoi5').val())-parseFloat($('#tongchi4').val()));
    $('#tonglai4').val(parseFloat($('#treem12tuoi5').val())-parseFloat($('#tongchi4').val()));
    $('#tonglai5').val(parseFloat($('#tongthunguoilon1').val())-parseFloat($('#tongchi5').val())+parseFloat($('#tongtien_thu').val()));
    $('#tonglai6').val(parseFloat($('#tongthunguoilon2').val())-parseFloat($('#tongchi6').val())+parseFloat($('#tongtien_thu1').val()));
    $('#tonglai7').val(parseFloat($('#treem2tuoi9').val())-parseFloat($('#tongchi7').val()));
    $('#tonglai8').val(parseFloat($('#treem2tuoi11').val())-parseFloat($('#tongchi8').val()));
    $('#tonglai9').val(parseFloat($('#treem12tuoi9').val())-parseFloat($('#tongchi9').val()));
    $('#tonglai10').val(parseFloat($('#treem12tuoi11').val())-parseFloat($('#tongchi10').val()));
    $('#tonglai11').val(Math.round(parseFloat($('#tongthunguoilon3').val())-parseFloat($('#tongchi11').val())).toFixed(2));
    $('#tonglai12').val(parseFloat($('#tongthunguoilon4').val())-parseFloat($('#tongchi12').val()));
