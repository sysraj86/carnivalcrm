            ...
            <div id="tabs-1">
                <table>
                    ...
                    <tr>
                        ...
                        <td class="ct_sl1"><input type="text" value="{$KS3SAONGUOILON2}" class="calculate" name="ks3saonguoilon2"
                                id="ks3saonguoilon2" size="10"/></td>
                        <td class="ct_sl1"><input type="text" value="{$KS3SAONGUOILON3}" class="calculate" name="ks3saonguoilon3"
                                id="ks3saonguoilon3" size="10"/></td>
                        <td class="ct_sl1"><input type="text" value="{$KS4SAONGUOILON1}" class="calculate" name="ks4saonguoilon1"
                                id="ks4saonguoilon1" size="10"/></td>
                        <td class="ct_sl1"><input type="text" value="{$KS4SAONGUOILON2}" class="calculate" name="ks4saonguoilon2"
                        ...
                        <td class="ct_sl2"><input type="text" value="{$KS3SAONGUOILON5}" class="calculate" name="ks3saonguoilon5"
                                id="ks3saonguoilon5" size="10"/></td>
                        <td class="ct_sl2"><input type="text" value="{$KS3SAONGUOILON6}" class="calculate" name="ks3saonguoilon6"
                                id="ks3saonguoilon6" size="10"/></td>
                        <td class="ct_sl2"><input type="text" value="{$KS4SAONGUOILON3}" class="calculate" name="ks4saonguoilon3"
                                id="ks4saonguoilon3" size="10"/></td>
                        <td class="ct_sl2"><input type="text" value="{$KS4SAONGUOILON4}" class="calculate" name="ks4saonguoilon4"
                    ...
                    <tr>
                        ...
                        <td class="ct_sl1"><input type="text" value="{$TREEM2TUOI2}" name="treem2tuoi2" class="treem"
                                id="treem2tuoi2" size="10"/></td>
                        <td class="ct_sl1"><input type="text" value="{$TREEM2TUOI3}" name="treem2tuoi3" class="treem"
                    ...
                    <tr>
                        ...
                        <td class="ct_sl1">&nbsp;</td>
                        <td class="ct_sl1">&nbsp;</td>
                        <td class="ct_sl1"><input name="tongthute1" type="text" class="disable tinhtoan" id="tongthute1"
                                value="{$TONGTHUTE1}" size="10"/></td>
                        <td class="ct_sl1">&nbsp;</td>
                        <td class="ct_sl1"><input name="tongthute2" type="text" class="disable tinhtoan" id="tongthute2"
                                value="{$TONGTHUTE2}" size="10"/></td>
                        <td class="ct_sl1">&nbsp;</td>
                        <td colspan="3" align="right" class="ct_sl2"><input name="tongthute3" type="text" class="disable tinhtoan"
                                id="tongthute3" value="{$TONGTHUTE3}" size="10"/></td>
                        <td class="ct_sl2">&nbsp;</td>
                        <td class="ct_sl2"><input name="tongthute4" type="text" class="disable tinhtoan" id="tongthute4"
            ...
            <div id="tabs-2">
                <table>
                    <tr bgcolor="#6699FF">
                        ...
                        <td align="center" class="dataField">&nbsp;</td>
                        <td colspan="7" align="right"><input name="tongchivanchuyen1" type="text" class="disable tinhtoan formatnumber"
                                id="tongchivanchuyen1" value="{$TONGCHIVANCHUYEN1}"/></td>
                        <td colspan="6" align="right"><input name="tongchivanchuyen2" type="text" class="disable tinhtoan formatnumber"
                    ...
                    <tr>
                        ...
                        <td><input type="text" value="{$VMBNGUOILON3}" name="vmbnguoilon3" id="vmbnguoilon3" class="calculate dongia"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" value="{$VMBNGUOILON4}" name="vmbnguoilon4" id="vmbnguoilon4" class="calculate formatnumber"
                                size="10"/></td>
                        <td>&nbsp;</td>
                        ...
                        <td><input type="text" value="{$VMBNGUOILON7}" name="vmbnguoilon7" class="calculate dongia" id="vmbnguoilon7"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" value="{$VMBNGUOILON8}" name="vmbnguoilon8" class="calculate formatnumber" id="vmbnguoilon8"
                                size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" value="{$TAXTAMTINH3}" name="taxtamtinh3" class="calculate dongia" id="taxtamtinh3"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" value="{$TAXTAMTINH4}" class="calculate formatnumber" name="taxtamtinh4" id="taxtamtinh4"
                                size="10"/></td>
                        <td>&nbsp;</td>
                        ...
                        <td><input type="text" value="{$TAXTAMTINH7}" class="calculate dongia" name="taxtamtinh7" id="taxtamtinh7"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" value="{$TAXTAMTINH8}" class="calculate formatnumber" name="taxtamtinh8" id="taxtamtinh8"
                                size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" name="vmbnguoilonnd3" value="{$VMBNGUOILONND3}" id="vmbnguoilonnd3"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" name="vmbnguoilonnd4" value="{$VMBNGUOILONND4}" id="vmbnguoilonnd4"
                                size="10"/></td>
                        <td>&nbsp;</td>
                        ...
                        <td><input type="text" class="calculate dongia" name="vmbnguoilonnd7" value="{$VMBNGUOILONND7}" id="vmbnguoilonnd7"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" name="vmbnguoilonnd8" value="{$VMBNGUOILONND8}" id="vmbnguoilonnd8"
                                size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" value="{$XEDONTIEN3}" class="calculate dongia" name="xedontien3" id="xedontien3" size="10"/>
                        </td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" value="{$XEDONTIEN4}" class="calculate formatnumber" name="xedontien4" id="xedontien4" size="10"/>
                        </td>
                        <td>&nbsp;</td>
                        ...
                        <td><input type="text" value="{$XEDONTIEN7}" class="calculate dongia" name="xedontien7" id="xedontien7" size="10"/>
                        </td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" value="{$XEDONTIEN8}" class="calculate formatnumber" name="xedontien8" id="xedontien8" size="10"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" value="{$VMBTREEM2TUOI3}" class="calculate dongia" name="vmbtreem2tuoi3" id="vmbtreem2tuoi3"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" value="{$VMBTREEM2TUOI4}" class="calculate formatnumber" name="vmbtreem2tuoi4" id="vmbtreem2tuoi4"
                                size="10"/></td>
                        <td>&nbsp;</td>
                        ...
                        <td><input type="text" value="{$VMBTREEM2TUOI7}" class="calculate dongia" name="vmbtreem2tuoi7" id="vmbtreem2tuoi7"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" value="{$VMBTREEM2TUOI8}" class="calculate formatnumber" name="vmbtreem2tuoi8" id="vmbtreem2tuoi8"
                                size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$VMBTREEM2TUOIND3}" name="vmbtreem2tuoind3"
                                id="vmbtreem2tuoind3" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$VMBTREEM2TUOIND4}" name="vmbtreem2tuoind4"
                        ...
                        <td><input type="text" class="calculate dongia" name="vmbtreem2tuoind7" value="{$VMBTREEM2TUOIND7}"
                                id="vmbtreem2tuoind7" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" name="vmbtreem2tuoind8" value="{$VMBTREEM2TUOIND8}"
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$VMBTREEM12TUOI3}" name="vmbtreem12tuoi3"
                                id="vmbtreem12tuoi3" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" value="{$VMBTREEM12TUOI4}" name="vmbtreem12tuoi4" id="vmbtreem12tuoi4" size="10" class="formatnumber"/>
                        </td>
                        <td>&nbsp;</td>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$VMBTREEM12TUOI7}" name="vmbtreem12tuoi7"
                                id="vmbtreem12tuoi7" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$VMBTREEM12TUOI8}" name="vmbtreem12tuoi8"
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$VMBTREEM12TUOIND3}" name="vmbtreem12tuoind3"
                                id="vmbtreem12tuoind3" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$VMBTREEM12TUOIND4}" name="vmbtreem12tuoind4"
                        ...
                        <td><input type="text" class="calculate dongia" value="{$VMBTREEM12TUOIND7}" name="vmbtreem12tuoind7"
                                id="vmbtreem12tuoind7" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$VMBTREEM12TUOIND8}" name="vmbtreem12tuoind8"
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" name="taxtreem3" value="{$TAXTREEM3}" id="taxtreem3" size="10"/>
                        </td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" name="taxtreem4" value="{$TAXTREEM4}" id="taxtreem4" size="10"/>
                        </td>
                        <td>&nbsp;</td>
                        ...
                        <td><input type="text" class="calculate dongia" name="taxtreem7" value="{$TAXTREEM7}" id="taxtreem7" size="10"/>
                        </td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" name="taxtreem8" value="{$TAXTREEM8}" id="taxtreem8" size="10"/>
                        </td>
                    </tr>
                </table>
            </div>
            <div id="tabs-3">
                <table>
                    <tr bgcolor="#6699FF">
                        ...
                        <td colspan="6" align="right"><input name="sumlandfeepackage2" type="text" class="disable tinhtoan"
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$LANFEE1_3_3}" name="landfee1_3_3" id="landfee1_3_3" size="10"/>
                        </td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$LANFEE1_3_4}" name="landfee1_3_4" id="landfee1_3_4" size="10"/>
                        </td>
                        <td>&nbsp;</td>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$LANFEE1_3_7}" name="landfee1_3_7" id="landfee1_3_7" size="10"/>
                        </td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$LANFEE1_3_8}" name="landfee1_3_8" id="landfee1_3_8" size="10"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" value="{$LANDFEE_2_3_3}" class="calculate dongia" name="landfee_2_3_3" id="landfee_2_3_3"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$LANDFEE_2_3_4}" name="landfee_2_3_4" id="landfee_2_3_4"
                                size="10"/></td>
                        <td>&nbsp;</td>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$LANDFEE_2_3_7}" name="landfee_2_3_7" id="landfee_2_3_7"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$LANDFEE_2_3_8}" name="landfee_2_3_8" id="landfee_2_3_8"
                                size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$LANDFEE_1_4_3}" name="landfee_1_4_3" id="landfee_1_4_3"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$LANDFEE_1_4_4}" name="landfee_1_4_4" id="landfee_1_4_4"
                                size="10"/></td>
                        <td>&nbsp;</td>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$LANDFEE_1_4_7}" name="landfee_1_4_7" id="landfee_1_4_7"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$LANDFEE_1_4_8}" name="landfee_1_4_8" id="landfee_1_4_8"
                                size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$LANDFEE_2_4_3}" name="landfee_2_4_3" id="landfee_2_4_3"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$LANDFEE_2_4_4}" name="landfee_2_4_4" id="landfee_2_4_4"
                                size="10"/></td>
                        <td>&nbsp;</td>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$LANDFEE_2_4_7}" name="landfee_2_4_7" id="landfee_2_4_7"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$LANDFEE_2_4_8}" name="landfee_2_4_8" id="landfee_2_4_8"
                                size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input name="upgrade_meal2" type="text" value="{$UPGRADE_MEAL2}" class="calculate" id="upgrade_meal2"
                                size="10"/></td>
                        <td><input type="text" class="calculate dongia" value="{$UPGRADE_MEAL3}" name="upgrade_meal3" id="upgrade_meal3"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$UPGRADE_MEAL4}" name="upgrade_meal4" id="upgrade_meal4"
                                size="10"/></td>
                        <td>&nbsp;</td>
                        ...
                        <td><input type="text" class="calculate" value="{$UPGRADE_MEAL6}" name="upgrade_meal6" id="upgrade_meal6"
                                size="10"/></td>
                        <td><input type="text" class="calculate dongia" value="{$UPGRADE_MEAL7}" name="upgrade_meal7" id="upgrade_meal7"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$UPGRADE_MEAL8}" name="upgrade_meal8" id="upgrade_meal8"
                                size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$OPTIONAL_TOUR3}" name="optional_tour3" id="optional_tour3"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td colspan="2"><input type="text" value="{$OPTIONAL_TOUR4}" name="optional_tour4" id="optional_tour4" size="10" class="formatnumber"/>
                        </td>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$OPTIONAL_TOUR7}" name="optional_tour7" id="optional_tour7"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$OPTIONAL_TOUR8}" name="optional_tour8" id="optional_tour8"
                                size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$SINGLE_SUPP_3}" name="single_supp_3" id="single_supp_3"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td colspan="2"><input type="text" value="{$SINGLE_SUPP_4}" class="calculate formatnumber" name="single_supp_4"
                        ...
                        <td><input type="text" class="calculate dongia" value="{$SINGLE_SUPP_7}" name="single_supp_7" id="single_supp_7"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$SINGLE_SUPP_8}" name="single_supp_8" id="single_supp_8"
                                size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$LANDFEETREEM_2_3_SAO3}" name="landfeetreem_2_3sao3"
                                id="landfeetreem_2_3sao3" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td colspan="2"><input type="text" value="{$LANDFEETREEM_2_3_SAO4}" class="calculate formatnumber" name="landfeetreem_2_3sao4"
                        ...
                        <td><input type="text" class="calculate dongia" value="{$LANDFEETREEM_2_3_SAO7}" name="landfeetreem_2_3sao7"
                                id="landfeetreem_2_3sao7" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$LANDFEETREEM_2_3_SAO8}" name="landfeetreem_2_3sao8"
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$LANDFEETREEM12_3SAO3}" name="landfeetreem12_3sao3"
                                id="landfeetreem12_3sao3" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td colspan="2"><input type="text" value="{$LANDFEETREEM12_3SAO4}" class="calculate formatnumber" name="landfeetreem12_3sao4"
                        ...
                        <td><input type="text" class="calculate dongia" value="{$LANDFEETREEM12_3SAO7}" name="landfeetreem12_3sao7"
                                id="landfeetreem12_3sao7" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$LANDFEETREEM12_3SAO8}" name="landfeetreem12_3sao8"
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$LANDFEE4SAO_TREEM2TUOI3}" name="landfee4sao_treem2tuoi3"
                                id="landfee4sao_treem2tuoi3" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td colspan="2"><input type="text" value="{$LANDFEE4SAO_TREEM2TUOI4}" class="calculate formatnumber"
                        ...
                        <td><input type="text" class="calculate dongia" value="{$LANDFEE4SAO_TREEM2TUOI7}" name="landfee4sao_treem2tuoi7"
                                id="landfee4sao_treem2tuoi7" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$LANDFEE4SAO_TREEM2TUOI8}" name="landfee4sao_treem2tuoi8"
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$LANDFEE4SAO_TREEM12TUOI3}" name="landfee4sao_treem12tuoi3"
                                id="landfee4sao_treem12tuoi3" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td colspan="2"><input type="text" class="calculate formatnumber" value="{$LANDFEE4SAO_TREEM12TUOI4}"
                        ...
                        <td><input type="text" class="calculate dongia" value="{$LANDFEE4SAO_TREEM12TUOI7}" name="landfee4sao_treem12tuoi7"
                                id="landfee4sao_treem12tuoi7" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$LANDFEE4SAO_TREEM12TUOI8}" name="landfee4sao_treem12tuoi8"
            ...
            <div id="tabs-4">
                <table>
                    <tr bgcolor="#6699FF">
                        ...
                        <td align="center" class="dataField">&nbsp;</td>
                        <td align="center" class="dataField">&nbsp;</td>
                        <td colspan="7" align="right"><input name="sumvisa1" type="text" class="disable tinhtoan" id="sumvisa1"
                                value="{$SUMVISA1}"/></td>
                        <td colspan="6" align="right"><input name="sumvisa2" type="text" class="disable tinhtoan" id="sumvisa2"
                                value="{$SUMVISA2}"/></td>
                    </tr>
                    <tr>
                        <td class="dataLabel">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$VISATHONGHANH3}" name="visathonghanh3" id="visathonghanh3"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$VISATHONGHANH4}" name="visathonghanh4" id="visathonghanh4"
                                size="10"/></td>
                        <td>&nbsp;</td>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$VISATHONGHANH7}" name="visathonghanh7" id="visathonghanh7"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$VISATHONGHANH8}" name="visathonghanh8" id="visathonghanh8"
                                size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$VISADICHTHUAT3}" name="visadichthuat3" id="visadichthuat3"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$VISADICHTHUAT4}" name="visadichthuat4" id="visadichthuat4"
                                size="10"/></td>
                        <td>&nbsp;</td>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$VISADICHTHUAT7}" name="visadichthuat7" id="visadichthuat7"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$VISADICHTHUAT8}" name="visadichthuat8" id="visadichthuat8"
                                size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$PHICHUYENPHATHOSO3}" name="phichuyenphathoso3"
                                id="phichuyenphathoso3" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$PHICHUYENPHATHOSO4}" name="phichuyenphathoso4"
                        ...
                        <td><input type="text" class="calculate dongia" value="{$PHICHUYENPHATHOSO7}" name="phichuyenphathoso7"
                                id="phichuyenphathoso7" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$PHICHUYENPHATHOSO8}" name="phichuyenphathoso8"
                    ...
                    <tr>
                        ...
                        <td><input type="text" value="{$PHITHUMOI3}" class="calculate dongia" name="phithumoi3" id="phithumoi3" size="10"/>
                        </td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" value="{$PHITHUMOI4}" class="calculate formatnumber" name="phithumoi4" id="phithumoi4" size="10"/>
                        </td>
                        <td>&nbsp;</td>
                        ...
                        <td><input type="text" value="{$PHITHUMOI7}" class="calculate dongia" name="phithumoi9" id="phithumoi9" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" value="{$PHITHUMOI8}" class="calculate formatnumber" name="phithumoi8" id="phithumoi8" size="10"/>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$VISATREEM2TUOI3}" name="visatreem2tuoi3"
                                id="visatreem2tuoi3" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$VISATREEM2TUOI4}" name="visatreem2tuoi4"
                        ...
                        <td><input type="text" class="calculate dongia" value="{$VISATREEM2TUOI7}" name="visatreem2tuoi7"
                                id="visatreem2tuoi7" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$VISATREEM2TUOI8}" name="visatreem2tuoi8"
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$VISATREEM12TUOI3}" name="visatreem12tuoi3"
                                id="visatreem12tuoi3" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$VISATREEM12TUOI4}" name="visatreem12tuoi4"
                        ...
                        <td><input type="text" class="calculate dongia" value="{$VISATREEM12TUOI7}" name="visatreem12tuoi7"
                                id="visatreem12tuoi7" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="calculate formatnumber" value="{$VISATREEM12TUOI8}" name="visatreem12tuoi8"
            ...
            <div id="tabs-5">
                <table>
                    <tr bgcolor="#6699FF">
                        ...
                        <td align="center" class="dataField">&nbsp;</td>
                        <td>&nbsp;</td>
                        <td colspan="6" align="right"><input name="sumguide1" type="text" class="disable tinhtoan" id="sumguide1"
                                value="{$SUMGUIDE1}"/></td>
                        <td>&nbsp;</td>
                        <td colspan="5" align="right"><input name="sumguide2" type="text" class="disable tinhtoan" id="sumguide2"
                                value="{$SUMGUIDE2}"/></td>
                    </tr>
                    <tr>
                        <td class="dataLabel">&nbsp;</td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="calculate" value="{$TOUR_LEADER2}" name="tour_leader2" id="tour_leader2"
                                size="10"/></td>
                        <td><input type="text" class="calculate dongia" value="{$TOUR_LEADER3}" name="tour_leader3" id="tour_leader3"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="disable formatnumber" value="{$TOUR_LEADER4}" name="tour_leader4" id="tour_leader4"
                                size="10"/></td>
                        <td>&nbsp;</td>
                        ...
                        <td><input type="text" class="calculate" value="{$TOUR_LEADER6}" name="tour_leader6" id="tour_leader6"
                                size="10"/></td>
                        <td><input type="text" class="calculate dongia" value="{$TOUR_LEADER7}" name="tour_leader7" id="tour_leader7"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="disable formatnumber" value="{$TOUR_LEADER8}" name="tour_leader8" id="tour_leader8"
                                size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" name="chiphikhac3" id="chiphikhac3" value="0{$CHIPHIKHAC3}"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="disable formatnumber" name="chiphikhac4" id="chiphikhac4" value="{$CHIPHIKHAC4}"
                                size="10"/></td>
                        <td>&nbsp;</td>
                        ...
                        <td><input type="text" class="calculate dongia" name="chiphikhac7" id="chiphikhac7" value="{$CHIPHIKHAC7}"
                                size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="disable formatnumber" name="chiphikhac8" id="chiphikhac8" value="{$CHIPHIKHAC8}"
                                size="10"/></td>
                    </tr>
                </table>
            </div>
            ...
            <div id="tabs-6">
                <table>
                    <tr bgcolor="#3399FF">
                        ...
                        <td align="center" class="dataField">&nbsp;</td>
                        <td>&nbsp;</td>
                        <td colspan="5" align="right"><input type="text" class="disable tinhtoan" value="{$SUMOTHERSERVICE1}"
                                name="sumotherservice1" id="sumotherservice1"/></td>
                        <td>&nbsp;</td>
                        <td colspan="5" align="right"><input type="text" class="disable tinhtoan" value="{$SUMOTHERSERVICE2}"
                    ...
                    <tr>
                        ...
                        <td><input type="text" value="{$BAOHIEM3}" class="calculate dongia" name="baohiem3" id="baohiem3" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" value="{$BAOHIEM4}" class="disable formatnumber" name="baohiem4" id="baohiem4" size="10"/></td>
                        ...
                        <td><input type="text" value="{$BAOHIEM7}" class="calculate dongia" name="baohiem7" id="baohiem7" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" value="{$BAOHIEM8}" class="disable formatnumber" name="baohiem8" id="baohiem8" size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$BAOHIEMTREEM2TUOI3}" name="baohiemtreem2tuoi3"
                                id="baohiemtreem2tuoi3" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="disable formatnumber" value="{$BAOHIEMTREEM2TUOI4}" name="baohiemtreem2tuoi4"
                        ...
                        <td><input type="text" name="baohiemtreem2tuoi7" value="{$BAOHIEMTREEM2TUOI7}" class="calculate dongia"
                                id="baohiemtreem2tuoi7" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="disable formatnumber" value="{$BAOHIEMTREEM2TUOI8}" name="baohiemtreem2tuoi8"
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$BAOHIEMTREEM12TUOI3}" name="baohiemtreem12tuoi3"
                                id="baohiemtreem12tuoi3" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="disable formatnumber" value="{$BAOHIEMTREEM12TUOI4}" name="baohiemtreem12tuoi4"
                        ...
                        <td><input type="text" class="calculate dongia" value="{$BAOHIEMTREEM12TUOI5}" name="baohiemtreem12tuoi7"
                                id="baohiemtreem12tuoi7" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="disable formatnumber" value="{$BAOHIEMTREEM12TUOI8}" name="baohiemtreem12tuoi8"
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$VISATIP3}" name="visatip3" id="visatip3" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="disable formatnumber" value="{$VISATIP4}" name="visatip4" id="visatip4" size="10"/></td>
                        ...
                        <td><input type="text" class="calculate dongia" value="{$VISATIP7}" name="visatip7" id="visatip7" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="disable formatnumber" value="{$VISATIP8}" name="visatip8" id="visatip8" size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" name="quatang3" value="{$QUATANG3}" id="quatang3" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="disable formatnumber" name="quatang4" value="{$QUATANG4}" id="quatang4" size="10"/></td>
                        ...
                        <td><input type="text" class="calculate dongia" name="quatang7" value="{$QUATANG7}" id="quatang7" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="disable formatnumber" name="quatang8" value="{$QUATANG8}" id="quatang8" size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" value="{$LAND2_3}" class="calculate dongia" name="land2_3" id="land2_3" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" value="{$LAND2_4}" class="disable formatnumber" name="land2_4" id="land2_4" size="10"/></td>
                        ...
                        <td><input type="text" value="{$LAND2_7}" class="calculate dongia" name="land2_7" id="land2_7" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" value="{$LAND2_8}" class="disable formatnumber" name="land2_8" id="land2_8" size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" name="cpk3" id="cpk3" value="{$CPK3}" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="disable formatnumber" name="cpk4" id="cpk4" value="{$CPK4}" size="10"/></td>
                        ...
                        <td><input type="text" class="calculate dongia" name="cpk7" id="cpk7" value="{$CPK7}" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="disable formatnumber" name="cpk8" id="cpk8" value="{$CPK8}" size="10"/></td>
                    </tr>
                    <tr>
                        ...
                        <td><input type="text" class="calculate dongia" name="chenhlechtygia3" id="chenhlechtygia3"
                                value="{$CHENHLECHTYGIA3}" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="disable formatnumber" name="chenhlechtygia4" id="chenhlechtygia4"
                        ...
                        <td><input type="text" class="calculate dongia" name="chenhlechtygia7" id="chenhlechtygia7"
                                value="{$CHENHLECHTYGIA7}" size="10"/></td>
                        <td>$</td>
                        <td>=</td>
                        <td><input type="text" class="disable formatnumber" name="chenhlechtygia8" id="chenhlechtygia8"
                            ...
                            <table width="100%" border="1" style="border-collapse: collapse;" cellspacing="0"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="chi_dongia[]" id="chi_dongia" class="chi_dongia chioption numbers dongia"  size="15"></td>
                                        <td><input type="text" name="chi_thanhtien[]" id="chi_thanhtien"  class="chioption numbers chi_thanhtien" size="15"></td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                            ...
                            <table width="100%" border="1" style="border-collapse:collapse;" cellspacing="0"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" name="thu_dongia[]" id="thu_dongia" class="thuoption numbers dongia thu_dongia1" size="15"></td>
                                        <td><input type="text" name="thu_thanhtien[]" id="thu_thanhtien" class="thuoption numbers thu_thanhtien1 formatnumber" size="15"></td>
                                        <td><input type="text" name="thu_dongiamot[]" id="thu_dongiamot" class="thuoption numbers dongia thu_dongia2" size="15"></td>
                                        <td><input type="text" name="thu_thanhtienmot[]" id="thu_thanhtienmot" class="thuoption numbers formatnumber thu_thanhtien2" size="15"></td>
                                        <td>&nbsp;</td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    {/if}
        ...
        <div id="tabs-9">
            <table cellpadding="0" cellspacing="0" border="1" style="border-collapse: collapse;" width="100%">
                ...
                <tr>
                    ...
                    <td class="ct_sl2"><input type="text" class="disable formatnumber" name="tongchi1" id="tongchi1" value="{$TONGCHI1}"
                            size="10"/></td>
                    <td class="ct_sl2"><input type="text" class="disable formatnumber" name="tongchi2" id="tongchi2" value="{$TONGCHI2}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="tongchi3" id="tongchi3" value="{$TONGCHI3}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="tongchi4" id="tongchi4" value="{$TONGCHI4}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="tongchi5" id="tongchi5" value="{$TONGCHI5}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="tongchi6" id="tongchi6" value="{$TONGCHI6}"
                            size="10"/></td>
                    <td>&nbsp;</td>
                    <td class="ct_sl2"><input type="text" class="disable" name="tongchi7" id="tongchi7" value="{$TONGCHI7}"
                            size="10"/></td>
                    <td class="ct_sl2"><input type="text" class="disable" name="tongchi8" id="tongchi8" value="{$TONGCHI8}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="tongchi9" id="tongchi9" value="{$TONGCHI9}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="tongchi10" id="tongchi10" value="{$TONGCHI10}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="tongchi11" id="tongchi11" value="{$TONGCHI11}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="tongchi12" id="tongchi12" value="{$TONGCHI12}"
                            size="10"/></td>
                </tr>
                <tr>
                    <td class="ct_sl3 dataLabel">GIÁ NET</td>
                    <td class="ct_sl2"><input type="text" class="disable" name="gianet1" id="gianet1" value="{$GIANET1}"
                            size="10"/></td>
                    <td class="ct_sl2"><input type="text" class="disable" name="gianet2" id="gianet2" value="{$GIANET2}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="gianet3" id="gianet3" value="{$GIANET3}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="gianet4" id="gianet4" value="{$GIANET4}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="gianet5" id="gianet5" value="{$GIANET5}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="gianet6" id="gianet6" value="{$GIANET6}"
                            size="10"/></td>
                    <td>&nbsp;</td>
                    <td class="ct_sl2"><input type="text" class="disable" name="gianet7" id="gianet7" value="{$GIANET7}"
                            size="10"/></td>
                    <td class="ct_sl2"><input type="text" class="disable" name="gianet8" id="gianet8" value="{$GIANET8}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="gianet9" id="gianet9" value="{$GIANET9}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="gianet10" id="gianet10" value="{$GIANET10}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="gianet11" id="gianet11" value="{$GIANET11}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="gianet12" id="gianet12" value="{$GIANET12}"
                            size="10"/></td>
                </tr>
                <tr>
                    <td class="ct_sl3 tinhtoan dataLabel">GIÁ BÁN</td>
                    <td class="ct_sl2"><input type="text" class="disable tinhtoan" name="giaban1" id="giaban1"
                            value="{$GIABAN1}" size="10"/></td>
                    <td class="ct_sl2"><input type="text" class="disable tinhtoan" name="giaban2" id="giaban2"
                            value="{$GIABAN2}" size="10"/></td>
                    <td class="ct_sl3"><input name="giaban3" type="text" class="disable tinhtoan" id="giaban3"
                            value="{$GIABAN3}" size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable tinhtoan" name="giaban4" id="giaban4"
                            value="{$GIABAN4}" size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="giaban calculate tinhtoan" name="giaban5" id="giaban5"
                            value="{$GIABAN5}" size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="giaban calculate tinhtoan" name="giaban6" id="giaban6"
                            value="{$GIABAN6}" size="10"/></td>
                    <td>&nbsp;</td>
                    <td class="ct_sl2"><input type="text" class="disable tinhtoan" name="giaban7" id="giaban7"
                            value="{$GIABAN7}" size="10"/></td>
                    <td class="ct_sl2"><input type="text" class="disable tinhtoan" name="giaban8" id="giaban8"
                            value="{$GIABAN8}" size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable tinhtoan" name="giaban9" id="giaban9"
                    ...
                    <td class="ct_sl3"><input type="text" class="giaban calculate tinhtoan" name="giaban11" id="giaban11"
                            value="{$GIABAN11}" size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="giaban calculate tinhtoan" name="giaban12" id="giaban12"
                            value="{$GIABAN12}" size="10"/></td>
                </tr>
                <tr>
                    <td class="ct_sl3 dataLabel">LÃI/KHÁCH</td>
                    <td class="ct_sl2"><input type="text" class="disable" name="laikhach1" id="laikhach1" value="{$LAIKHACH1}"
                            size="10"/></td>
                    <td class="ct_sl2"><input type="text" class="disable" name="laikhach2" id="laikhach2" value="{$LAIKHACH2}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="laikhach3" id="laikhach3" value="{$LAIKHACH3}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="laikhach4" id="laikhach4" value="{$LAIKHACH4}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="laikhach5" id="laikhach5" value="{$LAIKHACH5}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="laikhach6" id="laikhach6" value="{$LAIKHACH6}"
                            size="10"/></td>
                    <td>&nbsp;</td>
                    <td class="ct_sl2"><input type="text" class="disable" name="laikhach7" id="laikhach7" value="{$LAIKHACH7}"
                            size="10"/></td>
                    <td class="ct_sl2"><input type="text" class="disable" name="laikhach8" id="laikhach8" value="{$LAIKHACH8}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="laikhach9" id="laikhach9" value="{$LAIKHACH9}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="laikhach10" id="laikhach10"
                            value="{$LAIKHACH10}" size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="laikhach11" id="laikhach11"
                            value="{$LAIKHACH11}" size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="laikhach12" id="laikhach12"
                            value="{$LAIKHACH12}" size="10"/></td>
                </tr>
                <tr>
                    <td class="ct_sl3 dataLabel">TỔNG LÃI</td>
                    <td class="ct_sl2"><input type="text" class="disable" name="tonglai1" id="tonglai1" value="{$TONGLAI1}"
                            size="10"/></td>
                    <td class="ct_sl2"><input type="text" class="disable" name="tonglai2" id="tonglai2" value="{$TONGLAI2}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="tonglai3" id="tonglai3" value="{$TONGLAI3}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="tonglai4" id="tonglai4" value="{$TONGLAI4}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="tonglai5" id="tonglai5" value="{$TONGLAI5}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="tonglai6" id="tonglai6" value="{$TONGLAI6}"
                            size="10"/></td>
                    <td>&nbsp;</td>
                    <td class="ct_sl2"><input type="text" class="disable" name="tonglai7" id="tonglai7" value="{$TONGLAI7}"
                            size="10"/></td>
                    <td class="ct_sl2"><input type="text" class="disable" name="tonglai8" id="tonglai8" value="{$TONGLAI8}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="tonglai9" id="tonglai9" value="{$TONGLAI9}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="tonglai10" id="tonglai10" value="{$TONGLAI10}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="tonglai11" id="tonglai11" value="{$TONGLAI11}"
                            size="10"/></td>
                    <td class="ct_sl3"><input type="text" class="disable" name="tonglai12" id="tonglai12" value="{$TONGLAI12}"
                            size="10"/></td>
                </tr>
                <tr>
