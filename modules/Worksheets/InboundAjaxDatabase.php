    ...
    if(isset($_POST['tour_id'])){
        ...
        if($id){
            ...
            if(count($airArrtk)>0){
                ...
                if(count($app_list_strings['list_airlinetiket_dom_north'])>0){
                    $html .= '<tr>';
                    $html .= '<td colspan="7">';
                ...
                if(count($app_list_strings['list_airlinetiket_dom_middle'])>0){
                    $html .= '<tr>';
                    $html .= '<td colspan="7">';
                ...
                if(count($app_list_strings['list_airlinetiket_dom_south'])>0){
                    $html .= '<tr>';
                    $html .= '<td colspan="7">';
            ...
            if(count($nhArr)>0){
                ...
                if(count($app_list_strings['list_restaurant_dom_north'])>0){
                ...
                if(count($app_list_strings['list_restaurant_dom_middle'])>0){
                ...
                if(count($app_list_strings['list_restaurant_dom_south'])>0){
                    $html .= '<tr> <td colspan="9">';
                    $html .= '<fieldset>';
            ...
            if(count($app_list_strings['list_destination_north_dom'])>0){
            ...
            if(count($app_list_strings['list_destination_middle_dom'])>0) {
                $html .= '<tr><td colspan="13">';
                $html .= '<fieldset >';
                $html .= '<legend><h3>MIỀN TRUNG</h3></legend>';
            ...
            if(count($app_list_strings['list_destination_south_dom'])){
                $html .= '<tr><td colspan="13">';
                $html .= '<fieldset >';
                $html .= '<legend><h3>MIỀN NAM</h3></legend>';
            ...
            if(count($vcArr)>0){
                ...
                if(count($app_list_strings['list_vanchuyen_dom_north'])>0){
                ...
                if(count($app_list_strings['list_vanchuyen_dom_middle'])>0) {
                    $html .= '<tr><td colspan="8">';
                    $html .= '<fieldset >';
                    $html .= '<legend><h3>MIỀN TRUNG</h3></legend>';
                ...
                if(count($app_list_strings['list_vanchuyen_dom_south'])>0){
                    $html .= '<tr><td colspan="8">';
                    $html .= '<fieldset >';
                    $html .= '<legend><h3>MIỀN NAM</h3></legend>';
            ...
            if(count($svArr)>0){
                ...
                if(count($app_list_strings['list_dichvu_dom_north'])>0){
                    $html .= '<tr><td colspan="8">';
                    $html .= '<fieldset >';
                    $html .= '<legend><h3>MIỀN BẮC</h3></legend>';
                ...
                if(count($app_list_strings['list_dichvu_dom_middle'])>0){
                    $html .= '<tr><td colspan="8">';
                    $html .= '<fieldset >';
                    $html .= '<legend><h3>MIỀN TRUNG</h3></legend>';
                ...
                if(count($app_list_strings['list_dichvu_dom_south']) >0){
                    $html .= '<tr><td colspan="8">';
                    $html .= '<fieldset>';
                    $html .= '<legend><h3>MIỀN NAM</h3></legend>';
            ...
            if(count($tqArr)>0){
                ...
                if(count($app_list_strings['list_thamquan_dom_north'])>0){
                ...
                if(count($app_list_strings['list_thamquan_dom_middle']) >0){
                    $html .= '<tr><td colspan="10">';
                    $html .= '<fieldset >';
                    $html .= '<legend><h3>MIỀN TRUNG</h3></legend>';
                ...
                if(count($app_list_strings['list_thamquan_dom_south'])>0){
                    $html .= '<tr><td colspan="10">';
                    $html .= '<fieldset >';
                    $html .= '<legend><h3>MIỀN NAM</h3></legend>';
