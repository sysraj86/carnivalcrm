...
<table cellpadding="0" cellpadding="0" border="0" width="100%" class="tabDetailView">
    ...
    <tr>
        <td class="tabDetailViewDL hopdongdichvu" > Do:  </td>
        <td class="tabDetailViewDF hopdongdichvu"> {$SALUTATION_B} {$DAIDIENBENB_NAME}</td>
        <td class="tabDetailViewDL hopdongdichvu">Chức vụ: </td>
        <td class="tabDetailViewDF hopdongdichvu">{$POSITION_B}</td>
    </tr>
    {if $PARENT eq 'FITs'}
...
<div class="hopdongdichvu">
    ...
    <table class="tabDetailView" cellpadding="0" cellspacing="0" border="0" width="100%">
        ...
        <tr>
            <td colspan="4"> Khách hàng vui lòng thanh toán bằng {$TIENTE_USD}  {$TIENTE_VND} {$TEN_NGANHANG}</td>
        </tr>
        <tr>
            <td colspan="4">
                <h4> <u> Bao gồm</u></h4> 
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" class="tabForm">
    ...
    <tr>
        <td class="tabDetailViewDL">Từ ngày</td>
        <td class="tabDetailViewDF">{$GUIDE_START_DATE}"/></td>
        <td class="tabDetailViewDL">Đến ngày</td>
        <td class="tabDetailViewDF">{$GUIDE_END_DATE}/td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="tabDetailViewDF" colspan="2">{$BONUS}{$CURRENCY} X {$GUIDE_NUM_OF_DATE} ngày = {$TOTAL_BONUS} <label class="currency">{$CURRENCY}</label></td>
    </tr>
    <tr>
