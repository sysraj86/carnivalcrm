  ...
  class ContractsViewEdit extends ViewEdit{
      function ContractsViewEdit(){
        ...
        function display(){
            ...
            //$this->ev->ss->assign('CALENDAR_DATEFORMAT', $timedate->get_cal_date_format());
            //$this->ev->ss->assign('USER_DATEFORMAT', $timedate->get_user_date_format()); 
      ...
      function preDisplay(){
        ...
        if(empty($_SESSION['groupLayout'])) {
         ...
         $this->ev->setup($this->module, $this->bean, $metadataFile, 'modules/Contracts/tpls/EditView.tpl');    
