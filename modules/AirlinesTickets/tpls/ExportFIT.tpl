<html xmlns:v="urn:schemas-microsoft-com:vml"
    ...
    <head>
        ...
        <style>
            ...
            /* Page Definitions */
            @page
            {mso-footnote-separator:url("{SITE_URL}/modules/AirlinesTickets/tpls/files/header.htm") fs;
                mso-footnote-continuation-separator:url("{SITE_URL}/modules/AirlinesTickets/tpls/files/header.htm") fcs;
                mso-endnote-separator:url("{SITE_URL}/modules/AirlinesTickets/tpls/files/header.htm") es;
            mso-endnote-continuation-separator:url("{SITE_URL}/modules/AirlinesTickets/tpls/files/header.htm") ecs;}
            @page WordSection1
            {size:8.5in 11.0in;
    ...
    <body>
        ...
        <h1 align="center">Danh Sach Ve May Bay - {NAME}</h1>
        <br /><br /><br /><br />
        <b>To:</b> {AIRLINE}
        <p></p>
        {FIT_LIST} 
            
            <table cellpadding="0" cellspacing="0" border="0" width="100%" align="center" style="padding: 2px; border-collapse: collapse;">
                <tr>
                    <td colspan="3">Fare: {FARE}</td>
                </tr> 
                <tr>
                    <td colspan="3">Commission: {COMMISSON}</td>
                </tr>
                <tr>
                    <td colspan="3" >Tax/Fee/Charge: {TAXFEECHANGE}</td>
                </tr> 
                <tr>
                    <td width="40%">Nett: {NETT}</td> <td width="30%">ROE: {ROE}</td> <td width="30%">Equivalent in VND: {EQUIVALENT}</td>
                </tr>
                <tr><br />
                    <td align="right" colspan="3">Hồ Chí Minh&nbsp;&nbsp;......../......./20...</td>
                </tr><br /><br /><br /><br />
                <tr>
                    <td align="left">Messenger</td><td align="center">Airlines Representative</td><td align="right">Ticket Agency</td>
                </tr>
                <tr>
                    <td align="left">{MESSENGER}</td><td align="center">{AIRLINESREPRESENTATIVE}</td><td align="right">{TICKETAGENCY}</td>
                </tr>
            </table>
        </div>
    </body>
