...
<form action="index.php"  name="EditView" id="EditView" method="post">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" class="tabForm">
        ...
        <tr>
            ...
            <td class="dataField">
                <input class="sqsEnabled" name="tour_name" id="tour_name" size="50" type="text" value="{$TOUR_NAME}"/> <input type="hidden" id="tour_id" name="tour_id" value="{$TOUR_ID}" />
                <input title="{$APP.LBL_SELECT_BUTTON_TITLE}" accessKey="{$APP.LBL_SELECT_BUTTON_KEY}" type="button" tabindex='2' class="button" value='{$APP.LBL_SELECT_BUTTON_LABEL}' name="bnt_tour_name_group" id="bnt_tour_name_group" onclick='open_popup("Tours", 600, 400, "", true, false, {$tour_popup_request_data}, "single", true);'>
            </td>
        </tr>
        <tr>
            ...
            <td class="dataField"> From <input type="text" size="11" id="start_date_group" name="start_date_group" value="{$START_DATE_GROUP}"/>&nbsp;&nbsp;&nbsp; 
                To <input type="text" size="11" id="end_date_group" name="end_date_group" value="{$END_DATE_GROUP}"/>
            </td>
        </tr>
        <tr>
