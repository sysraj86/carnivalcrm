...
<table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <tr>
        ...
        <td class="tabDetailViewDF">:{TRUONGDOAN}</td>
    </tr>
    <tr>
        ...
        <td class="tabDetailViewDF">
            <table>
                <tr>
                    <td class="tabDetailViewDF">Xe đón - tiễn</td>
                    <td class="tabDetailViewDF"> Xe tham quan</td>
                </tr>
                <tr>
                    <td class="tabDetailViewDF">{SOXE}</td>
                    <td class="tabDetailViewDF">{SOXE1}</td>
                </tr>
                <tr>
                    <td class="tabDetailViewDF">{TAIXE}</td>
                    <td class="tabDetailViewDF">{TAIXE1}</td>
                </tr>
            </table>
        </td>
    </tr>
