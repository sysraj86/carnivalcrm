...
class SightSeeingCars extends SugarBean {
	var $db;
	var $field_name_map;
	...
	var $deleted;
    var $driver_sight;
    var $driver_phone_sight;
    var $number_plates_sight;
    var $groupprogram_id;
    var $sightseeing_car_id;
	
	var $object_name = 'SightSeeingCars';
	var $table_name = 'sightseeingcars';
	
	var $disable_row_level_security = true;
	var $module_dir = 'SightSeeingCars';
