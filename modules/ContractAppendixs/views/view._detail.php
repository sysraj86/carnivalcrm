    ...
    class ContractAppendixsViewDetail extends ViewDetail{
        ...
        function display(){
            ...
            if (isset($_REQUEST['offset']) or isset($_REQUEST['record'])) {
               $result = $detailView->processSugarBean("CONTRACTAPPENDIXS", $this->bean, $offset);
                if($result == null) {
      ...
      //      echo "\n</p>\n";
            ...
            $this->dv->ss->assign("CONTRACT_NUMBER",  $this->bean->number_contract);
            $this->dv->ss->assign("TOUR",  $this->bean->tour);
            $this->dv->ss->assign("TOUR_ID",  $this->bean->tour_id);
            ...
            $this->dv->ss->assign("PHONE_A", $this->bean->phone_a);
            $this->dv->ss->assign("FAX", $this->bean->fax);
