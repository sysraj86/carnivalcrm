...
class PHPWord_Writer_Word2007 implements PHPWord_Writer_IWriter {
    ...
    public function output($fileName = '', $saveInPath = ''){
        
        $this->save($fileName);
        
        $fileName = $fileName != '' ? $fileName : basename($_SERVER['PHP_SELF'], '.php') . '.docx';
        ...
        header('Content-Description: File Transfer');
           ...
           // header('Content-Type: application/download', false);
            ...
            header("Content-Type: application/msword; charset=unicode");
