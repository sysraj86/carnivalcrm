...
class ContractAppendixValues extends SugarBean {
	var $db;
	var $field_name_map;
	// Stored fields
	var $id;
	var $date_modified;
    var $deleted;
	var $contract_appendixs_value_id;
    var $service;
	var $num_of_service;
    var $unit; 
	var $tax;
	...
	var $object_name = 'ContractAppendixValues';
	var $table_name = 'contractappendixvalues';
	
	var $disable_row_level_security = true;
	var $module_dir = 'ContractAppendixValues';
