...
$dictionary['RestaurantBookingsLine'] = array(
'table' => 'restaurantbookingsline',
'fields' => array (
  'id' => 
  array (
    'name' => 'id',
  ...
  'restaurantbooking_id' => array(
    'name'     => 'restaurantbooking_id',
    'vname'    => '',
    'type'     => 'id',
    'required' => true,
  ),    
  'date_booking_time'   => array(
     'name'     => 'date_booking_time',
     'vname'    => '',
     'type'     => 'varchar',
     'len'      => 250,
   ),
...
'indices' => array (
       array('name' =>'restaurantbookingsline_spk', 'type' =>'primary', 'fields'=>array('id')),
      )
);
