...
class RestaurantBookingsLine extends SugarBean {
	var $db;
	var $field_name_map;
	// Stored fields
	var $id;
	var $date_modified;
    var $deleted;
	var $servicebooking_id;
    var $date_booking_time;  
    var $quantity;
	var $price;
    var $menu; 
	
	var $object_name = 'RestaurantBookingsLine';
	var $table_name = 'restaurantbookingsline';
	
	var $disable_row_level_security = true;
	var $module_dir = 'RestaurantBookingsLine';
